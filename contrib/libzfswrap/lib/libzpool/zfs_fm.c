...
/* zfs file management : most of these functions are disabled in zfs-fuse.
 * I have added warnings at the beginning of each one just to be sure they
 * are not called */
...
{
#if 0
    /* zfs fault management in kernel - not usefull in zfs-fuse normally... */
