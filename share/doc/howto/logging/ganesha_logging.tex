...
\item COMPONENT\_DISPATCH - Messages relating to the dispatch thread which is
  responsible for sending replies to clients.
...
\item COMPONENT\_NFSV4\_LOCK - 
\item COMPONENT\_NFSV4\_XATTR - 
\item COMPONENT\_NFSV4\_REFERRAL - 
...
Incrememnt log level of all components:
\begin{verbatim}
...
Decrement log level of all components:
\begin{verbatim}
...
\begin{verbatim}
$ cmdline_tools/ganesha_log_level -L
\end{verbatim}
...
\begin{verbatim}
$ cmdline_tools/ganesha_log_level -C
\end{verbatim}

get the log level for one or more components
\begin{verbatim}
$ cmdline_tools/ganesha_log_level -g COMPONENT_ALL
\end{verbatim}
...
\begin{verbatim}
$ cmdline_tools/ganesha_log_level -s NIV_DEBUG
\end{verbatim}
