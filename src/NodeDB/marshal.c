...
static FILE *finclude = NULL;
static FILE *fcsource = NULL;
static FILE *fops = NULL;
...
{
    fprintf (foutput, "/* This file is autogenerated -- do not edit */\n");
    fprintf (foutput, "/* This file is autogenerated -- do not edit */\n");
    fprintf (foutput, "/* This file is autogenerated -- do not edit */\n");
    fprintf (foutput, "/* This file is autogenerated -- do not edit */\n");
    fprintf (foutput, "\n\n");
    fprintf (foutput, "#include <pthread.h>\n");
    fprintf (foutput, "\n\n");
    fprintf (foutput, "#include <stdlib.h>\n");
    fprintf (foutput, "#include <stdio.h>\n");
    fprintf (foutput, "#include <string.h>\n");
    fprintf (foutput, "#include <sys/types.h>\n");
    fprintf (foutput, "#include <sys/stat.h>\n");
    fprintf (foutput, "#include <unistd.h>\n");
    fprintf (foutput, "\n\n");

    fprintf (foutput, "struct file_data;\n");
    fprintf (foutput, "struct stat;\n");
    fprintf (foutput, "struct nodedb;\n\n");
    fprintf (foutput, "struct connection;\n\n");

    fprintf (foutput, "#include \"sockbuf.h\"\n");
    fprintf (foutput, "#include \"nodedb.h\"\n");
    fprintf (foutput, "#include \"connection.h\"\n");
    fprintf (foutput, "#include \"connectionpool.h\"\n");
    fprintf (foutput, "#include \"ops.h\"\n");
    fprintf (foutput, "#include \"encoding.h\"\n");
    fprintf (foutput, "\n\n");
...
static void dump_ops (void)
{
    ...
    fprintf (fops, "/* This file is autogenerated -- do not edit */\n");
    fprintf (fops, "/* This file is autogenerated -- do not edit */\n");
    fprintf (fops, "/* This file is autogenerated -- do not edit */\n");
    fprintf (fops, "/* This file is autogenerated -- do not edit */\n");
    fprintf (fops, "\n\n");
...
int main (int argc, char **argv)
{
    ...
    for (i = 1; i < argc; i++) {
        if (!strncmp (argv[i], "-o", 2)) {
            FILE *f;
            if (i >= argc - 1) {
                fprintf (stderr, "marshal: error on command line: %s\n", argv[i]);
                exit (1);
            }
            if (!(f = fopen (argv[i + 1], "w"))) {
                fprintf (stderr, "marshal: cannot open file for writing: ");
                perror (argv[i + 1]);
                exit (1);
            }
            switch (argv[i][2]) {
    ...
    if (!fcsource || !finclude || !fops || !finput)
    {
        fprintf(stderr, "Usage: marshal -i nodedb.c -oc interface.c -oi interface.h -oo ops.h\n");
        exit(1);
    }
