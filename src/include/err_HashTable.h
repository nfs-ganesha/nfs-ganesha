...
#define ERR_HASHTABLE_GET            1
	{
	ERR_HASHTABLE_GET, "ERR_HASHTABLE_GET",
		    "Error when getting an entry"},
#define ERR_HASHTABLE_SET            2
	{
	ERR_HASHTABLE_SET, "ERR_HASHTABLE_SET",
		    "Error when setting an entry"},
#define ERR_HASHTABLE_DEL            3
	{
	ERR_HASHTABLE_DEL, "ERR_HASHTABLE_DEL",
		    "Error while deleting an entry"}, {
	ERR_NULL, "ERR_NULL", ""}
};
