...
#define ERR_GHOSTFS_NOENT    2
	{
	ERR_GHOSTFS_NOENT, "ERR_GHOSTFS_NOENT",
...
#define ERR_GHOSTFS_ISDIR   21
	{
	ERR_GHOSTFS_ISDIR, "ERR_GHOSTFS_ISDIR",
		    "Directory used in a non-directory operation"},
#define ERR_GHOSTFS_NOTEMPTY   23
	{
	ERR_GHOSTFS_NOTEMPTY, "ERR_GHOSTFS_NOTEMPTY",
		    "Directory is not empty"},
#define ERR_GHOSTFS_INTERNAL 1001
	{
	ERR_GHOSTFS_INTERNAL, "ERR_GHOSTFS_INTERNAL",
		    "GhostFS internal error"},
#define ERR_GHOSTFS_MALLOC   1002
	{
	ERR_GHOSTFS_MALLOC, "ERR_GHOSTFS_MALLOC",
		    "Memory allocation error"},
#define ERR_GHOSTFS_OPEN     1003
	{
	ERR_GHOSTFS_OPEN, "ERR_GHOSTFS_OPEN",
		    "Error opening fislesystem definition file"},
#define ERR_GHOSTFS_READ     1004
	{
	ERR_GHOSTFS_READ, "ERR_GHOSTFS_READ",
		    "Error while reading filesytem definition file"},
...
#define ERR_GHOSTFS_NOTOPENED   1014
	{
	ERR_GHOSTFS_NOTOPENED, "ERR_GHOSTFS_NOTOPENED",
