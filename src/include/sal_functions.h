...
state_status_t state_lock(cache_entry_t * entry, exportlist_t * export, struct req_op_context *req_ctx, state_owner_t * owner, state_t * state, state_blocking_t blocking, state_block_data_t * block_data, fsal_lock_param_t * lock, state_owner_t ** holder,	/* owner that holds conflicting lock */
			  fsal_lock_param_t * conflict,	/* description of conflicting lock */
...
state_status_t state_share_add(cache_entry_t * entry, state_owner_t * owner, state_t * state);	/* state that holds share bits to be added */

state_status_t state_share_remove(cache_entry_t * entry, state_owner_t * owner, state_t * state);	/* state that holds share bits to be removed */

state_status_t state_share_upgrade(cache_entry_t * entry, state_data_t * state_data,	/* new share bits */
				   state_owner_t * owner, state_t * state);	/* state that holds current share bits */

state_status_t state_share_downgrade(cache_entry_t * entry, state_data_t * state_data,	/* new share bits */
				     state_owner_t * owner, state_t * state);	/* state that holds current share bits */
