...
#define ERR_SVCUDP_CREATE  0
	{
	ERR_SVCUDP_CREATE, "ERR_SVCUDP_CREATE",
		    "svcudp_create impossible"},
#define ERR_SVCTCP_CREATE  1
	{
	ERR_SVCTCP_CREATE, "ERR_SVCTCP_CREATE",
		    "svctcp_create impossible"},
...
#define ERR_CLNTUDP_CREATE 4
	{
	ERR_CLNTUDP_CREATE, "ERR_CLNTUDP_CREATE",
		    "clntudp_create impossible"},
#define ERR_CLNTTCP_CREATE 5
	{
	ERR_CLNTTCP_CREATE, "ERR_CLNTTCP_CREATE",
		    "clnttcp_create impossible"},
