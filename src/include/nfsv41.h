...
/* new operations for NFSv4.1 */
	...
	static inline bool xdr_CB_RECALLABLE_OBJ_AVAIL4args(XDR * xdrs,
	...
	static inline bool xdr_CB_RECALLABLE_OBJ_AVAIL4res(XDR * xdrs,
...
/* Callback operations new to NFSv4.1 */
	...
	static inline bool xdr_fattr4_time_modify_set(XDR *,
						      fattr4_time_modify_set *);
	static inline bool xdr_fattr4_suppattr_exclcreat(XDR *,
							 fattr4_suppattr_exclcreat
							 *);
	static inline bool xdr_fattr4_dir_notif_delay(XDR *,
						      fattr4_dir_notif_delay *);
	static inline bool xdr_fattr4_dirent_notif_delay(XDR *,
							 fattr4_dirent_notif_delay
							 *);
	...
	static inline bool xdr_nfsv4_1_file_layout_ds_addr4(XDR *,
							    nfsv4_1_file_layout_ds_addr4
							    *);
	...
	static inline bool xdr_channel_dir_from_client4(XDR *,
							channel_dir_from_client4
							*);
	static inline bool xdr_BIND_CONN_TO_SESSION4args(XDR *,
							 BIND_CONN_TO_SESSION4args
							 *);
	static inline bool xdr_channel_dir_from_server4(XDR *,
							channel_dir_from_server4
							*);
	static inline bool xdr_BIND_CONN_TO_SESSION4resok(XDR *,
							  BIND_CONN_TO_SESSION4resok
							  *);
	...
	static inline bool xdr_CB_RECALLABLE_OBJ_AVAIL4args(XDR *,
							    CB_RECALLABLE_OBJ_AVAIL4args
							    *);
	static inline bool xdr_CB_RECALLABLE_OBJ_AVAIL4res(XDR *,
							   CB_RECALLABLE_OBJ_AVAIL4res
							   *);
