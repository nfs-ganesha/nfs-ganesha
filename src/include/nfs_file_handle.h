...
bool nfs4_FSALToFhandle(nfs_fh4 *,
			const struct fsal_obj_handle *);
bool nfs3_FSALToFhandle(nfs_fh3 *fh3, const struct fsal_obj_handle *);
bool nfs2_FSALToFhandle(fhandle2 *fh2, const struct fsal_obj_handle *);
