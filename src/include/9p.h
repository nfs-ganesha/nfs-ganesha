...
typedef int (*_9p_function_t) (_9p_request_data_t *req9p, void *pworker_data,
...
int _9p_link(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
	     char *preply);

int _9p_lock(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
	     char *preply);

int _9p_lopen(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
	      char *preply);

int _9p_mkdir(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
	      char *preply);

int _9p_mknod(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
	      char *preply);

int _9p_read(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
	     char *preply);
...
int _9p_setattr(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
		char *preply);

int _9p_symlink(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
		char *preply);

int _9p_remove(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
	       char *preply);

int _9p_rename(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
	       char *preply);

int _9p_renameat(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
		 char *preply);

int _9p_statfs(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
	       char *preply);

int _9p_fsync(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
	      char *preply);

int _9p_unlinkat(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
		 char *preply);

int _9p_version(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
		char *preply);

int _9p_walk(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
	     char *preply);

int _9p_write(_9p_request_data_t *req9p, void *pworker_data, u32 * plenout,
	      char *preply);
...
int _9p_rerror(_9p_request_data_t *req9p, void *pworker_data, u16 * msgtag,
