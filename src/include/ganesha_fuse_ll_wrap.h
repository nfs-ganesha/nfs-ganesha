...
struct ganefuse_lowlevel_ops {
    ...
    void (*setattr) (ganefuse_req_t req, ganefuse_ino_t ino, struct stat *attr,
                    int to_set, struct ganefuse_file_info *fi);
    ...
    void (*setlk) (ganefuse_req_t req, ganefuse_ino_t ino, struct ganefuse_file_info *fi,
     ...
     void (*bmap) (ganefuse_req_t req, ganefuse_ino_t ino, size_t blocksize,
                  uint64_t idx);
};
...
int ganefuse_reply_attr(ganefuse_req_t req, const struct stat *attr,
                    double attr_timeout);
...
int ganefuse_chan_send(struct ganefuse_chan *ch, const struct iovec iov[],
                   size_t count);
