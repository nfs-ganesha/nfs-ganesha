...
fsal_status_t COMMON_CleanUpExportContext_noerror(fsal_export_context_t *
						  p_export_context);
...
fsal_status_t COMMON_SetDefault_FSAL_parameter(fsal_parameter_t *
					       out_parameter);

fsal_status_t COMMON_SetDefault_FS_common_parameter(fsal_parameter_t *
						    out_parameter);
