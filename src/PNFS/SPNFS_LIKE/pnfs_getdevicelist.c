...
/**
 *
 * pnfs_spnfs_getdevicelist: manages the OP4_GETDEVICELIST operation for pNFS/File on top of SPNFS
 *
 * Manages the OP4_GETDEVICELISTT operation for pNFS/File on top of SPNFS
 *
...
nfsstat4 pnfs_spnfs_getdevicelist( GETDEVICELIST4args  * pgetdevicelistargs,
