...
fsal_ace_t *nfs4_ace_alloc(int nace)
{
	...
	ace = gsh_calloc(nace, sizeof(fsal_ace_t), MEM_COMP_ACL);
	return ace;
}

fsal_acl_t *nfs4_acl_alloc(void)
{
	fsal_acl_t *acl = gsh_calloc(1, sizeof(fsal_acl_t), MEM_COMP_ACL);
