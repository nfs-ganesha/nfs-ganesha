...
message(STATUS "CEPHFS_LIBRARY_DIR = ${CEPHFS_LIBRARY_DIR}")
...
if (NOT CEPH_FS)
  ...
  check_library_exists(cephfs ceph_ll_nonblocking_readv_writev ${CEPHFS_LIBRARY_DIR} CEPH_FS_NONBLOCKING_IO)
  if(NOT CEPH_FS_NONBLOCKING_IO)
...
#  check_library_exists(cephfs ceph_ll_readv_writev_v2 ${CEPHFS_LIBRARY_DIR} CEPH_FS_ZEROCOPY_IO)
#  if(NOT CEPH_FS_ZEROCOPY_IO)
#    message("Cannot find ceph_ll_readv_writev_v2. Disabling zero copy.")
    message("Disabling zero copy.")
...
#  endif(NOT CEPH_FS_ZEROCOPY_IO)
  check_include_files(linux/fscrypt.h HAVE_LINUX_FSCRYPT_H)
  check_library_exists(cephfs ceph_add_fscrypt_key ${CEPHFS_LIBRARY_DIR} CEPH_ADD_FSCRYPT_KEY)
  check_library_exists(cephfs ceph_ll_set_fscrypt_policy_v2 ${CEPHFS_LIBRARY_DIR} CEPH_LL_SET_FSCRYPT_POLICY_V2)
  check_library_exists(cephfs ceph_ll_is_encrypted ${CEPHFS_LIBRARY_DIR} CEPH_LL_IS_ENCRYPTED)
  if(NOT CEPH_ADD_FSCRYPT_KEY OR NOT CEPH_LL_SET_FSCRYPT_POLICY_V2 OR NOT CEPH_LL_IS_ENCRYPTED)
    message("Cannot find one or more of ceph_add_fcrypt_key, ceph_ll_set_fscrypt_policy_v2, ceph_ll_is_encrypted. Disabling fscrypt.")
    set(USE_FSAL_CEPH_FSCRYPT OFF)
  else(NOT CEPH_ADD_FSCRYPT_KEY OR NOT CEPH_LL_SET_FSCRYPT_POLICY_V2 OR NOT CEPH_LL_IS_ENCRYPTED)
    set(USE_FSAL_CEPH_FSCRYPT ON)
  endif(NOT CEPH_ADD_FSCRYPT_KEY OR NOT CEPH_LL_SET_FSCRYPT_POLICY_V2 OR NOT CEPH_LL_IS_ENCRYPTED)
endif (NOT CEPH_FS)
...
mark_as_advanced(USE_FSAL_CEPH_FSCRYPT)
