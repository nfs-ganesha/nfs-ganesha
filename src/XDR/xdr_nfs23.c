	...
	nfsdata2 *objp;
{
	...
	if (!xdr_bytes(xdrs, (char **)&objp->nfsdata2_val, (u_int *) &objp->nfsdata2_len, NFS2_MAXDATA))
		return (FALSE);
	return (TRUE);
}

bool_t
xdr_nfscookie2(xdrs, objp)
	register XDR *xdrs;
	nfscookie2 objp;
{
