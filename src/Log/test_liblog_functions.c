...
void TestAlways(int expect, char *buff, log_components_t component,
		char *string)
{
	char compare[2048];
...
{
	char compare[2048];
	sprintf(compare, "%s: MAJOR ERROR: %s",
...
{
	char compare[2048];
	sprintf(compare, "%s: EVENT: %s", LogComponents[component].comp_str,
		string);
	buff[0] = '\0';
...
{
	char compare[2048];
	sprintf(compare, "%s: DBG: %s", LogComponents[component].comp_str,
		string);
	buff[0] = '\0';
...
void TestFullDebug(int expect, char *buff, log_components_t component,
		   char *string)
{
	char compare[2048];
	sprintf(compare, "%s: F_DBG: %s", LogComponents[component].comp_str,
		string);
	buff[0] = '\0';
