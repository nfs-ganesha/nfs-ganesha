...
fsal_status_t FSAL_create(
  ...
  if ( rc ) Return( ghost2fsal_error(rc) ,rc , INDEX_FSAL_create );
...
)
{
  ...
  if ( rc ) Return( ghost2fsal_error(rc) ,rc , INDEX_FSAL_mkdir );
...
fsal_status_t FSAL_link(
  ...
  if ( rc ) Return( ghost2fsal_error(rc) ,rc , INDEX_FSAL_link );
