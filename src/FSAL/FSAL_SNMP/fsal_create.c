 ...
 */
fsal_status_t SNMPFSAL_create(fsal_handle_t * parent_directory_handle,      /* IN */
 ...
 *        the object_attributes->asked_attributes field.
 */
fsal_status_t SNMPFSAL_mkdir(fsal_handle_t * parent_directory_handle,       /* IN */
 ...
 */
fsal_status_t SNMPFSAL_link(fsal_handle_t * target_handle,  /* IN */
