...
fsal_functions_t fsal_snmp_functions = {
  ...
  .fsal_getclientcontext = SNMPFSAL_GetClientContext,
  ...
  .fsal_open_by_fileid = SNMPFSAL_open_by_fileid,
  .fsal_close_by_fileid = SNMPFSAL_close_by_fileid,
  .fsal_static_fsinfo = SNMPFSAL_static_fsinfo,
  ...
  .fsal_setattr_access = SNMPFSAL_setattr_access,
  .fsal_rename_access = SNMPFSAL_rename_access,
  .fsal_create_access = SNMPFSAL_create_access,
  .fsal_unlink_access = SNMPFSAL_unlink_access,
  .fsal_link_access = SNMPFSAL_link_access,
  .fsal_merge_attrs = SNMPFSAL_merge_attrs,
  .fsal_lookup = SNMPFSAL_lookup,
  .fsal_lookuppath = SNMPFSAL_lookupPath,
  .fsal_lookupjunction = SNMPFSAL_lookupJunction,
  .fsal_lock = SNMPFSAL_lock,
  .fsal_changelock = SNMPFSAL_changelock,
  .fsal_unlock = SNMPFSAL_unlock,
  .fsal_getlock = SNMPFSAL_getlock,
  .fsal_cleanobjectresources = SNMPFSAL_CleanObjectResources,
  .fsal_set_quota = SNMPFSAL_set_quota,
  .fsal_get_quota = SNMPFSAL_get_quota,
  .fsal_rcp = SNMPFSAL_rcp,
  .fsal_rcp_by_fileid = SNMPFSAL_rcp_by_fileid,
  ...
  .fsal_setdefault_fsal_parameter = SNMPFSAL_SetDefault_FSAL_parameter,
  .fsal_setdefault_fs_common_parameter = SNMPFSAL_SetDefault_FS_common_parameter,
  .fsal_setdefault_fs_specific_parameter = SNMPFSAL_SetDefault_FS_specific_parameter,
  .fsal_load_fsal_parameter_from_conf = SNMPFSAL_load_FSAL_parameter_from_conf,
  .fsal_load_fs_common_parameter_from_conf =
      SNMPFSAL_load_FS_common_parameter_from_conf,
