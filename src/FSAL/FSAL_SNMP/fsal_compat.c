...
{
  return SNMPFSAL_access( (snmpfsal_handle_t *)object_handle, (snmpfsal_op_context_t *)p_context, access_type, object_attributes ) ;
}
...
{
  return SNMPFSAL_getattrs( (snmpfsal_handle_t *)p_filehandle, (snmpfsal_op_context_t *)p_context, p_object_attributes ) ;
}
...
fsal_status_t WRAP_SNMPFSAL_setattrs(fsal_handle_t * p_filehandle,       /* IN */
                            ...
                            fsal_attrib_list_t * p_object_attributes    /* [ IN/OUT ] */)
{
  return SNMPFSAL_setattrs( (snmpfsal_handle_t *)p_filehandle, (snmpfsal_op_context_t *)p_context, p_attrib_set, p_object_attributes ) ;
}
...
{
  return SNMPFSAL_BuildExportContext( (snmpfsal_export_context_t *)p_export_context, p_export_path, fs_specific_options ) ;
}
...
{
  return SNMPFSAL_GetClientContext( (snmpfsal_op_context_t *)p_thr_context, (snmpfsal_export_context_t *)p_export_context, uid, gid, alt_groups, nb_alt_groups ) ;
}
...
fsal_status_t WRAP_SNMPFSAL_create(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */ ) 
{
  return SNMPFSAL_create( (snmpfsal_handle_t *) p_parent_directory_handle, p_filename, (snmpfsal_op_context_t *)p_context,
			   accessmode, (snmpfsal_handle_t *)p_object_handle, p_object_attributes ) ;
}
...
fsal_status_t WRAP_SNMPFSAL_mkdir(fsal_handle_t * p_parent_directory_handle,     /* IN */
                         ...
                         fsal_attrib_list_t * p_object_attributes       /* [ IN/OUT ] */)
{
  return SNMPFSAL_mkdir( (snmpfsal_handle_t *)p_parent_directory_handle, p_dirname, (snmpfsal_op_context_t *)p_context,
					accessmode, (snmpfsal_handle_t *)p_object_handle, p_object_attributes ) ;
}
...
{
  return SNMPFSAL_link( (snmpfsal_handle_t *)p_target_handle, (snmpfsal_handle_t *)p_dir_handle, p_link_name, (snmpfsal_op_context_t *)p_context, p_attributes ) ;
}
...
{
  return SNMPFSAL_mknode( (snmpfsal_handle_t *)parentdir_handle, p_node_name, (snmpfsal_op_context_t *)p_context, accessmode,
					 nodetype, dev,   (snmpfsal_handle_t *)p_object_handle, node_attributes ) ;
}
...
{
  return SNMPFSAL_opendir( (snmpfsal_handle_t *)p_dir_handle, (snmpfsal_op_context_t *)p_context, 
                           ...
                           fsal_boolean_t * p_end_of_dir        /* OUT */ ) 
{
  ...
  return SNMPFSAL_readdir( (snmpfsal_dir_t *)p_dir_descriptor, snmpcookie, get_attr_mask,
	     		  buffersize, p_pdirent, (snmpfsal_cookie_t *)p_end_position, p_nb_entries, p_end_of_dir ) ;
}
                                ...
                                fsal_attrib_list_t * file_attributes /* [ IN/OUT ] */ )
{
  return SNMPFSAL_open_by_name( (snmpfsal_handle_t *)dirhandle, filename, 
			       (snmpfsal_op_context_t *)p_context, openflags, (snmpfsal_file_t *)file_descriptor, file_attributes ) ;
}
...
{
  return SNMPFSAL_open( (snmpfsal_handle_t *)p_filehandle, (snmpfsal_op_context_t *)p_context, 
                       openflags, (snmpfsal_file_t *)p_file_descriptor, p_file_attributes ) ;
}
...
{
  return SNMPFSAL_read( (snmpfsal_file_t *)p_file_descriptor, p_seek_descriptor, buffer_size, buffer, p_read_amount, p_end_of_file ) ;
}
...
{
  return SNMPFSAL_write( (snmpfsal_file_t *)p_file_descriptor, p_seek_descriptor, buffer_size, buffer, p_write_amount ) ;
}
...
fsal_status_t WRAP_SNMPFSAL_open_by_fileid(fsal_handle_t * filehandle,   /* IN */
                                  ...
                                  fsal_attrib_list_t * file_attributes /* [ IN/OUT ] */ )
{
   return SNMPFSAL_open_by_fileid( (snmpfsal_handle_t *)filehandle, fileid, (snmpfsal_op_context_t *)p_context, 
                                   openflags, (snmpfsal_file_t *)file_descriptor, file_attributes ) ;
}
...
{
  return SNMPFSAL_static_fsinfo( (snmpfsal_handle_t *)p_filehandle, (snmpfsal_op_context_t *)p_context, p_staticinfo ) ;
}
...
{
  return SNMPFSAL_dynamic_fsinfo( (snmpfsal_handle_t *)p_filehandle, (snmpfsal_op_context_t *)p_context, p_dynamicinfo ) ;
}
...
{
  return SNMPFSAL_test_access( (snmpfsal_op_context_t *)p_context, access_type, p_object_attributes ) ;
}
...
{
  return SNMPFSAL_setattr_access( (snmpfsal_op_context_t *)p_context, candidate_attributes, object_attributes ) ;
}
...
fsal_status_t WRAP_SNMPFSAL_lookup(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */)
{
  return SNMPFSAL_lookup( (snmpfsal_handle_t *)p_parent_directory_handle, p_filename, (snmpfsal_op_context_t *)p_context,
...
fsal_status_t WRAP_SNMPFSAL_lookupPath(fsal_path_t * p_path,     /* IN */
                              ...
                              fsal_attrib_list_t * p_object_attributes  /* [ IN/OUT ] */)
{
  return SNMPFSAL_lookupPath( p_path, (snmpfsal_op_context_t *)p_context, (snmpfsal_handle_t *)object_handle, p_object_attributes ) ;
}
...
{  
  return SNMPFSAL_lookupJunction( (snmpfsal_handle_t *)p_junction_handle, (snmpfsal_op_context_t *)p_context, (snmpfsal_handle_t *)p_fsoot_handle, p_fsroot_attributes ) ;
}

fsal_status_t WRAP_SNMPFSAL_lock(fsal_file_t * obj_handle,
                        fsal_lockdesc_t * ldesc, fsal_boolean_t blocking)
{
  return SNMPFSAL_lock( (snmpfsal_file_t *)obj_handle, (snmpfsal_lockdesc_t *)ldesc, blocking ) ;
}
...
{
  return SNMPFSAL_rcp( (snmpfsal_handle_t *)filehandle, (snmpfsal_op_context_t *)p_context, p_local_path, transfer_opt ) ;
}
...
fsal_status_t WRAP_SNMPFSAL_rcp_by_fileid(fsal_handle_t * filehandle,    /* IN */
                                 ...
                                 fsal_rcpflag_t transfer_opt /* IN */ ) 
{
  return SNMPFSAL_rcp_by_fileid( (snmpfsal_handle_t *)filehandle, fileid, (snmpfsal_op_context_t *)p_context, p_local_path, transfer_opt ) ;
}
...
{
  return SNMPFSAL_rename( (snmpfsal_handle_t *)p_old_parentdir_handle, p_old_name, (snmpfsal_handle_t *)p_new_parentdir_handle, p_new_name, 
					 (snmpfsal_op_context_t *)p_context, p_src_dir_attributes, p_tgt_dir_attributes ) ;
}
...
{
  return SNMPFSAL_readlink( (snmpfsal_handle_t *)p_linkhandle, (snmpfsal_op_context_t *)p_context, p_link_content, p_link_attributes ) ;
}
...
fsal_status_t WRAP_SNMPFSAL_symlink(fsal_handle_t * p_parent_directory_handle,   /* IN */
                           ...
                           fsal_attrib_list_t * p_link_attributes       /* [ IN/OUT ] */) 
{
  return SNMPFSAL_symlink( (snmpfsal_handle_t *)p_parent_directory_handle, p_linkname, p_linkcontent, 
					  (snmpfsal_op_context_t *)p_context, accessmode, (snmpfsal_handle_t *)p_link_handle, p_link_attributes ) ;
}

int WRAP_SNMPFSAL_handlecmp(fsal_handle_t * handle1, fsal_handle_t * handle2,
                   fsal_status_t * status) 
{
  return SNMPFSAL_handlecmp( (snmpfsal_handle_t *)handle1, (snmpfsal_handle_t *)handle2, status ) ;
}
...
{
  return SNMPFSAL_Handle_to_HashIndex( (snmpfsal_handle_t *)p_handle, cookie, alphabet_len, index_size ) ;
}

unsigned int WRAP_SNMPFSAL_Handle_to_RBTIndex(fsal_handle_t * p_handle, unsigned int cookie)
{
...
{
  return SNMPFSAL_DigestHandle( (snmpfsal_export_context_t *)p_exportcontext, output_type, (snmpfsal_handle_t *)p_in_fsal_handle, out_buff ) ;
}
...
{
  return SNMPFSAL_ExpandHandle( (snmpfsal_export_context_t *)p_expcontext, in_type, in_buff, (snmpfsal_handle_t *)p_out_fsal_handle ) ;
}
...
fsal_status_t WRAP_SNMPFSAL_SetDefault_FS_common_parameter(fsal_parameter_t * out_parameter)
{
  return SNMPFSAL_SetDefault_FS_common_parameter( out_parameter ) ;
}

fsal_status_t WRAP_SNMPFSAL_SetDefault_FS_specific_parameter(fsal_parameter_t * out_parameter)
{
...
{
  return SNMPFSAL_truncate( (snmpfsal_handle_t *)p_filehandle, (snmpfsal_op_context_t *)p_context, length, 
...
{
  return SNMPFSAL_unlink( (snmpfsal_handle_t *)p_parent_directory_handle, p_object_name, (snmpfsal_op_context_t *)p_context, p_parent_directory_attributes ) ;
} 
...
{
  return SNMPFSAL_GetXAttrAttrs( (snmpfsal_handle_t *)p_objecthandle, (snmpfsal_op_context_t *)p_context, xattr_id, p_attrs ) ;
}
...
fsal_status_t WRAP_SNMPFSAL_ListXAttrs(fsal_handle_t * p_objecthandle,   /* IN */
                              ...
                              int *end_of_list  /* OUT */ ) 
{
  return SNMPFSAL_ListXAttrs( (snmpfsal_handle_t *)p_objecthandle, cookie, (snmpfsal_op_context_t *)p_context,
...
{
  return SNMPFSAL_GetXAttrValueById( (snmpfsal_handle_t *)p_objecthandle, xattr_id, (snmpfsal_op_context_t *)p_context, 
...
{
  return SNMPFSAL_GetXAttrIdByName( (snmpfsal_handle_t *)p_objecthandle, xattr_name, (snmpfsal_op_context_t *)p_context, pxattr_id ) ;
}
...
{
  return SNMPFSAL_GetXAttrValueByName( (snmpfsal_handle_t *)p_objecthandle, xattr_name, (snmpfsal_op_context_t *)p_context,
						      buffer_addr, buffer_size, p_output_size ) ;
}
...
fsal_status_t WRAP_SNMPFSAL_SetXAttrValue(fsal_handle_t * p_objecthandle,        /* IN */
                                 ...
                                 int create     /* IN */) 
{
  return SNMPFSAL_SetXAttrValue( (snmpfsal_handle_t *)p_objecthandle, xattr_name, (snmpfsal_op_context_t *)p_context,
...
fsal_status_t WRAP_SNMPFSAL_SetXAttrValueById(fsal_handle_t * p_objecthandle,    /* IN */
                                     ...
                                     size_t buffer_size /* IN */ ) 
{
  return SNMPFSAL_SetXAttrValueById( (snmpfsal_handle_t *)p_objecthandle, xattr_id, (snmpfsal_op_context_t *)p_context,
...
fsal_status_t WRAP_SNMPFSAL_RemoveXAttrById(fsal_handle_t * p_objecthandle,      /* IN */
                                   ...
                                   unsigned int xattr_id)       /* IN */
{
  return SNMPFSAL_RemoveXAttrById( (snmpfsal_handle_t *)p_objecthandle, (snmpfsal_op_context_t *)p_context, xattr_id ) ;
}
...
{
  return SNMPFSAL_RemoveXAttrByName( (snmpfsal_handle_t *)p_objecthandle, (snmpfsal_op_context_t *)p_context, xattr_name ) ;
}
...
fsal_functions_t fsal_snmp_functions = {
  ...
  .fsal_load_fs_common_parameter_from_conf = WRAP_SNMPFSAL_load_FS_common_parameter_from_conf,
  .fsal_load_fs_specific_parameter_from_conf = WRAP_SNMPFSAL_load_FS_specific_parameter_from_conf,
