...
extern snmpfs_specific_initinfo_t snmp_glob_config;
...
fsal_status_t SNMPFSAL_access(fsal_handle_t * p_object_handle,      /* IN */
                              fsal_op_context_t * p_context,        /* IN */
                              fsal_accessflags_t access_type,   /* IN */
                              fsal_attrib_list_t * p_object_attributes /* [ IN/OUT ] */ );

fsal_status_t SNMPFSAL_getattrs(fsal_handle_t * p_filehandle,       /* IN */
                                fsal_op_context_t * p_context,      /* IN */
                                fsal_attrib_list_t * p_object_attributes /* IN/OUT */ );

fsal_status_t SNMPFSAL_setattrs(fsal_handle_t * p_filehandle,       /* IN */
                                fsal_op_context_t * p_context,      /* IN */
                                fsal_attrib_list_t * p_attrib_set,      /* IN */
                                fsal_attrib_list_t *
                                p_object_attributes /* [ IN/OUT ] */ );

fsal_status_t SNMPFSAL_BuildExportContext(fsal_export_context_t * p_export_context, /* OUT */
                                          fsal_path_t * p_export_path,  /* IN */
                                          char *fs_specific_options /* IN */ );

fsal_status_t SNMPFSAL_CleanUpExportContext(fsal_export_context_t * p_export_context);

fsal_status_t SNMPFSAL_InitClientContext(fsal_op_context_t * p_thr_context);

fsal_status_t SNMPFSAL_create(fsal_handle_t * p_parent_directory_handle,    /* IN */
...
fsal_status_t SNMPFSAL_mkdir(fsal_handle_t * p_parent_directory_handle,     /* IN */
...
fsal_status_t SNMPFSAL_link(fsal_handle_t * p_target_handle,        /* IN */
                            fsal_handle_t * p_dir_handle,   /* IN */
                            fsal_name_t * p_link_name,  /* IN */
                            fsal_op_context_t * p_context,  /* IN */
                            fsal_attrib_list_t * p_attributes /* [ IN/OUT ] */ );

fsal_status_t SNMPFSAL_mknode(fsal_handle_t * parentdir_handle,     /* IN */
...
fsal_status_t SNMPFSAL_opendir(fsal_handle_t * p_dir_handle,        /* IN */
                               fsal_op_context_t * p_context,       /* IN */
                               fsal_dir_t * p_dir_descriptor,       /* OUT */
                               fsal_attrib_list_t * p_dir_attributes /* [ IN/OUT ] */ );

fsal_status_t SNMPFSAL_readdir(fsal_dir_t * p_dir_descriptor,       /* IN */
...
fsal_status_t SNMPFSAL_closedir(fsal_dir_t * p_dir_descriptor /* IN */ );
...
fsal_status_t SNMPFSAL_open(fsal_handle_t * p_filehandle,   /* IN */
                            fsal_op_context_t * p_context,  /* IN */
                            fsal_openflags_t openflags, /* IN */
                            fsal_file_t * p_file_descriptor,        /* OUT */
                            fsal_attrib_list_t * p_file_attributes /* [ IN/OUT ] */ );

fsal_status_t SNMPFSAL_read(fsal_file_t * p_file_descriptor,        /* IN */
...
fsal_status_t SNMPFSAL_write(fsal_file_t * p_file_descriptor,       /* IN */
                             fsal_seek_t * p_seek_descriptor,   /* IN */
                             fsal_size_t buffer_size,   /* IN */
                             caddr_t buffer,    /* IN */
                             fsal_size_t * p_write_amount /* OUT */ );

fsal_status_t SNMPFSAL_close(fsal_file_t * p_file_descriptor /* IN */ );
...
fsal_status_t SNMPFSAL_static_fsinfo(fsal_handle_t * p_filehandle,  /* IN */
                                     fsal_op_context_t * p_context, /* IN */
                                     fsal_staticfsinfo_t * p_staticinfo /* OUT */ );

fsal_status_t SNMPFSAL_dynamic_fsinfo(fsal_handle_t * p_filehandle, /* IN */
                                      fsal_op_context_t * p_context,        /* IN */
...
fsal_status_t SNMPFSAL_lookup(fsal_handle_t * p_parent_directory_handle,    /* IN */
                              fsal_name_t * p_filename, /* IN */
                              fsal_op_context_t * p_context,        /* IN */
                              fsal_handle_t * p_object_handle,      /* OUT */
                              fsal_attrib_list_t * p_object_attributes /* [ IN/OUT ] */ );
...
fsal_status_t SNMPFSAL_lock(fsal_file_t * obj_handle,
...
fsal_status_t SNMPFSAL_unlock(fsal_file_t * obj_handle, fsal_lockdesc_t * ldesc);

fsal_status_t SNMPFSAL_getlock(fsal_file_t * obj_handle, fsal_lockdesc_t * ldesc);

fsal_status_t SNMPFSAL_CleanObjectResources(fsal_handle_t * in_fsal_handle);
...
fsal_status_t SNMPFSAL_rename(fsal_handle_t * p_old_parentdir_handle,       /* IN */
...
fsal_status_t SNMPFSAL_readlink(fsal_handle_t * p_linkhandle,       /* IN */
                                fsal_op_context_t * p_context,      /* IN */
                                fsal_path_t * p_link_content,   /* OUT */
                                fsal_attrib_list_t * p_link_attributes /* [ IN/OUT ] */ );

fsal_status_t SNMPFSAL_symlink(fsal_handle_t * p_parent_directory_handle,   /* IN */
...
int SNMPFSAL_handlecmp(fsal_handle_t * handle1, fsal_handle_t * handle2,
                       fsal_status_t * status);

unsigned int SNMPFSAL_Handle_to_HashIndex(fsal_handle_t * p_handle,
                                          unsigned int cookie,
                                          unsigned int alphabet_len,
                                          unsigned int index_size);

unsigned int SNMPFSAL_Handle_to_RBTIndex(fsal_handle_t * p_handle,
                                         unsigned int cookie);
...
fsal_status_t SNMPFSAL_ExpandHandle(fsal_export_context_t * p_expcontext,   /* IN */
...
fsal_status_t SNMPFSAL_truncate(fsal_handle_t * p_filehandle,       /* IN */
                                fsal_op_context_t * p_context,      /* IN */
...
fsal_status_t SNMPFSAL_unlink(fsal_handle_t * p_parent_directory_handle,    /* IN */
...
fsal_status_t SNMPFSAL_GetXAttrAttrs(fsal_handle_t * p_objecthandle,        /* IN */
                                     fsal_op_context_t * p_context, /* IN */
                                     unsigned int xattr_id,     /* IN */
                                     fsal_attrib_list_t * p_attrs);

fsal_status_t SNMPFSAL_ListXAttrs(fsal_handle_t * p_objecthandle,   /* IN */
...
fsal_status_t SNMPFSAL_GetXAttrValueById(fsal_handle_t * p_objecthandle,    /* IN */
                                         unsigned int xattr_id, /* IN */
                                         fsal_op_context_t * p_context,     /* IN */
...
fsal_status_t SNMPFSAL_GetXAttrIdByName(fsal_handle_t * p_objecthandle,     /* IN */
                                        const fsal_name_t * xattr_name, /* IN */
                                        fsal_op_context_t * p_context,      /* IN */
                                        unsigned int *pxattr_id /* OUT */ );

fsal_status_t SNMPFSAL_GetXAttrValueByName(fsal_handle_t * p_objecthandle,  /* IN */
                                           const fsal_name_t * xattr_name,      /* IN */
                                           fsal_op_context_t * p_context,   /* IN */
                                           caddr_t buffer_addr, /* IN/OUT */
                                           size_t buffer_size,  /* IN */
...
fsal_status_t SNMPFSAL_SetXAttrValue(fsal_handle_t * p_objecthandle,        /* IN */
                                     const fsal_name_t * xattr_name,    /* IN */
                                     fsal_op_context_t * p_context, /* IN */
...
fsal_status_t SNMPFSAL_SetXAttrValueById(fsal_handle_t * p_objecthandle,    /* IN */
                                         unsigned int xattr_id, /* IN */
                                         fsal_op_context_t * p_context,     /* IN */
                                         caddr_t buffer_addr,   /* IN */
                                         size_t buffer_size /* IN */ );

fsal_status_t SNMPFSAL_RemoveXAttrById(fsal_handle_t * p_objecthandle,      /* IN */
                                       fsal_op_context_t * p_context,       /* IN */
                                       unsigned int xattr_id) /* IN */ ;

fsal_status_t SNMPFSAL_RemoveXAttrByName(fsal_handle_t * p_objecthandle,    /* IN */
                                         fsal_op_context_t * p_context,     /* IN */
                                         const fsal_name_t * xattr_name) /* IN */ ;
