...
const family_error_t tab_errstatus_FSAL[] = {
	...
	ERR_FSAL_XDEV, "ERR_FSAL_XDEV",
		    "This operation can't cross filesystems"}, {
	ERR_FSAL_NOTDIR, "ERR_FSAL_NOTDIR", "This object is not a directory"},
	{
	ERR_FSAL_ISDIR, "ERR_FSAL_ISDIR",
		    "Directory used in a nondirectory operation"}, {
	...
	ERR_FSAL_NAMETOOLONG, "ERR_FSAL_NAMETOOLONG",
	...
	{
	ERR_FSAL_BADTYPE, "ERR_FSAL_BADTYPE",
		    "Invalid type for create operation"}, {
	...
	ERR_FSAL_ATTRNOTSUPP, "ERR_FSAL_ATTRNOTSUPP",
		    "Attribute not supported"}, {
	ERR_FSAL_NOT_INIT, "ERR_FSAL_NOT_INIT", "Filesystem not initialized"},
	{
	ERR_FSAL_ALREADY_INIT, "ERR_FSAL_ALREADY_INIT",
		    "Filesystem already initialised"}, {
	ERR_FSAL_BAD_INIT, "ERR_FSAL_BAD_INIT",
		    "Filesystem initialisation error"}, {
	ERR_FSAL_SEC, "ERR_FSAL_SEC", "Security context error"}, {
	ERR_FSAL_NO_QUOTA, "ERR_FSAL_NO_QUOTA", "No Quota available"}, {
	ERR_FSAL_NOT_OPENED, "ERR_FSAL_NOT_OPENED",
