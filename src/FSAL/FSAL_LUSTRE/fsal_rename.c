  ...
  if(p_src_dir_attributes)
    {
      ...
      status = LUSTREFSAL_getattrs(p_old_parentdir_handle, p_context, p_src_dir_attributes);
  ...
  if(p_tgt_dir_attributes)
    {
      ...
      status = LUSTREFSAL_getattrs(p_new_parentdir_handle, p_context, p_tgt_dir_attributes);
