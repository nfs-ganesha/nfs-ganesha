...
fsal_functions_t fsal_lustre_functions = {
  ...
  .fsal_initclientcontext = LUSTREFSAL_InitClientContext,
  .fsal_getclientcontext = LUSTREFSAL_GetClientContext,
  ...
  .fsal_open_by_fileid = LUSTREFSAL_open_by_fileid,
  .fsal_close_by_fileid = LUSTREFSAL_close_by_fileid,
  ...
  .fsal_setattr_access = LUSTREFSAL_setattr_access,
  .fsal_rename_access = LUSTREFSAL_rename_access,
  .fsal_create_access = LUSTREFSAL_create_access,
  .fsal_unlink_access = LUSTREFSAL_unlink_access,
  .fsal_link_access = LUSTREFSAL_link_access,
  .fsal_merge_attrs = LUSTREFSAL_merge_attrs,
  .fsal_lookup = LUSTREFSAL_lookup,
  .fsal_lookuppath = LUSTREFSAL_lookupPath,
  .fsal_lookupjunction = LUSTREFSAL_lookupJunction,
  .fsal_lock = LUSTREFSAL_lock,
  .fsal_changelock = LUSTREFSAL_changelock,
  .fsal_unlock = LUSTREFSAL_unlock,
  .fsal_getlock = LUSTREFSAL_getlock,
  .fsal_cleanobjectresources = LUSTREFSAL_CleanObjectResources,
  .fsal_set_quota = LUSTREFSAL_set_quota,
  .fsal_get_quota = LUSTREFSAL_get_quota,
  .fsal_rcp = LUSTREFSAL_rcp,
  .fsal_rcp_by_fileid = LUSTREFSAL_rcp_by_fileid,
  ...
  .fsal_getextattrs = LUSTREFSAL_getextattrs,
