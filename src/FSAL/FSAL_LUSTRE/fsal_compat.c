...
{
  return LUSTREFSAL_access( (lustrefsal_handle_t *)object_handle, (lustrefsal_op_context_t *)p_context, access_type, object_attributes ) ;
}
...
{
  return LUSTREFSAL_getattrs( (lustrefsal_handle_t *)p_filehandle, (lustrefsal_op_context_t *)p_context, p_object_attributes ) ;
}
...
fsal_status_t WRAP_LUSTREFSAL_setattrs(fsal_handle_t * p_filehandle,       /* IN */
                            ...
                            fsal_attrib_list_t * p_object_attributes    /* [ IN/OUT ] */)
{
  return LUSTREFSAL_setattrs( (lustrefsal_handle_t *)p_filehandle, (lustrefsal_op_context_t *)p_context, p_attrib_set, p_object_attributes ) ;
}
...
{
  return LUSTREFSAL_BuildExportContext( (lustrefsal_export_context_t *)p_export_context, p_export_path, fs_specific_options ) ;
}
...
{
  return LUSTREFSAL_GetClientContext( (lustrefsal_op_context_t *)p_thr_context, (lustrefsal_export_context_t *)p_export_context, uid, gid, alt_groups, nb_alt_groups ) ;
}
...
fsal_status_t WRAP_LUSTREFSAL_create(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */ ) 
{
  return LUSTREFSAL_create( (lustrefsal_handle_t *) p_parent_directory_handle, p_filename, (lustrefsal_op_context_t *)p_context,
			   accessmode, (lustrefsal_handle_t *)p_object_handle, p_object_attributes ) ;
}
...
fsal_status_t WRAP_LUSTREFSAL_mkdir(fsal_handle_t * p_parent_directory_handle,     /* IN */
                         ...
                         fsal_attrib_list_t * p_object_attributes       /* [ IN/OUT ] */)
{
  return LUSTREFSAL_mkdir( (lustrefsal_handle_t *)p_parent_directory_handle, p_dirname, (lustrefsal_op_context_t *)p_context,
					accessmode, (lustrefsal_handle_t *)p_object_handle, p_object_attributes ) ;
}
...
{
  return LUSTREFSAL_link( (lustrefsal_handle_t *)p_target_handle, (lustrefsal_handle_t *)p_dir_handle, p_link_name, (lustrefsal_op_context_t *)p_context, p_attributes ) ;
}
...
{
  return LUSTREFSAL_mknode( (lustrefsal_handle_t *)parentdir_handle, p_node_name, (lustrefsal_op_context_t *)p_context, accessmode,
					 nodetype, dev,   (lustrefsal_handle_t *)p_object_handle, node_attributes ) ;
}
...
{
  return LUSTREFSAL_opendir( (lustrefsal_handle_t *)p_dir_handle, (lustrefsal_op_context_t *)p_context, 
                           ...
                           fsal_boolean_t * p_end_of_dir        /* OUT */ ) 
{
  ...
  return LUSTREFSAL_readdir( (lustrefsal_dir_t *)p_dir_descriptor, lustrecookie, get_attr_mask,
	     		  buffersize, p_pdirent, (lustrefsal_cookie_t *)p_end_position, p_nb_entries, p_end_of_dir ) ;
}
                                ...
                                fsal_attrib_list_t * file_attributes /* [ IN/OUT ] */ )
{
  return LUSTREFSAL_open_by_name( (lustrefsal_handle_t *)dirhandle, filename, 
			       (lustrefsal_op_context_t *)p_context, openflags, (lustrefsal_file_t *)file_descriptor, file_attributes ) ;
}
...
{
  return LUSTREFSAL_open( (lustrefsal_handle_t *)p_filehandle, (lustrefsal_op_context_t *)p_context, 
                       openflags, (lustrefsal_file_t *)p_file_descriptor, p_file_attributes ) ;
}
...
{
  return LUSTREFSAL_read( (lustrefsal_file_t *)p_file_descriptor, p_seek_descriptor, buffer_size, buffer, p_read_amount, p_end_of_file ) ;
}
...
{
  return LUSTREFSAL_write( (lustrefsal_file_t *)p_file_descriptor, p_seek_descriptor, buffer_size, buffer, p_write_amount ) ;
}
...
fsal_status_t WRAP_LUSTREFSAL_open_by_fileid(fsal_handle_t * filehandle,   /* IN */
                                  ...
                                  fsal_attrib_list_t * file_attributes /* [ IN/OUT ] */ )
{
   return LUSTREFSAL_open_by_fileid( (lustrefsal_handle_t *)filehandle, fileid, (lustrefsal_op_context_t *)p_context, 
                                   openflags, (lustrefsal_file_t *)file_descriptor, file_attributes ) ;
}
...
{
  return LUSTREFSAL_static_fsinfo( (lustrefsal_handle_t *)p_filehandle, (lustrefsal_op_context_t *)p_context, p_staticinfo ) ;
}
...
{
  return LUSTREFSAL_dynamic_fsinfo( (lustrefsal_handle_t *)p_filehandle, (lustrefsal_op_context_t *)p_context, p_dynamicinfo ) ;
}
...
{
  return LUSTREFSAL_test_access( (lustrefsal_op_context_t *)p_context, access_type, p_object_attributes ) ;
}
...
{
  return LUSTREFSAL_setattr_access( (lustrefsal_op_context_t *)p_context, candidate_attributes, object_attributes ) ;
}
...
{
  return LUSTREFSAL_rename_access( (lustrefsal_op_context_t *)pcontext, pattrsrc, pattrdest ) ;
}
...
fsal_status_t WRAP_LUSTREFSAL_lookup(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */)
{
  return LUSTREFSAL_lookup( (lustrefsal_handle_t *)p_parent_directory_handle, p_filename, (lustrefsal_op_context_t *)p_context,
...
fsal_status_t WRAP_LUSTREFSAL_lookupPath(fsal_path_t * p_path,     /* IN */
                              ...
                              fsal_attrib_list_t * p_object_attributes  /* [ IN/OUT ] */)
{
  return LUSTREFSAL_lookupPath( p_path, (lustrefsal_op_context_t *)p_context, (lustrefsal_handle_t *)object_handle, p_object_attributes ) ;
}
...
{  
  return LUSTREFSAL_lookupJunction( (lustrefsal_handle_t *)p_junction_handle, (lustrefsal_op_context_t *)p_context, (lustrefsal_handle_t *)p_fsoot_handle, p_fsroot_attributes ) ;
}

fsal_status_t WRAP_LUSTREFSAL_lock(fsal_file_t * obj_handle,
                        fsal_lockdesc_t * ldesc, fsal_boolean_t blocking)
{
  return LUSTREFSAL_lock( (lustrefsal_file_t *)obj_handle, (lustrefsal_lockdesc_t *)ldesc, blocking ) ;
}
...
{
  return LUSTREFSAL_unlock( (lustrefsal_file_t *)obj_handle, (lustrefsal_lockdesc_t *)ldesc ) ;
}

fsal_status_t WRAP_LUSTREFSAL_getlock(fsal_file_t * obj_handle, fsal_lockdesc_t * ldesc)
{
  return LUSTREFSAL_getlock( (lustrefsal_file_t *)obj_handle, (lustrefsal_lockdesc_t *)ldesc ) ;
}
...
{
  return LUSTREFSAL_rcp( (lustrefsal_handle_t *)filehandle, (lustrefsal_op_context_t *)p_context, p_local_path, transfer_opt ) ;
}
...
fsal_status_t WRAP_LUSTREFSAL_rcp_by_fileid(fsal_handle_t * filehandle,    /* IN */
                                 ...
                                 fsal_rcpflag_t transfer_opt /* IN */ ) 
{
  return LUSTREFSAL_rcp_by_fileid( (lustrefsal_handle_t *)filehandle, fileid, (lustrefsal_op_context_t *)p_context, p_local_path, transfer_opt ) ;
}
...
{
  return LUSTREFSAL_rename( (lustrefsal_handle_t *)p_old_parentdir_handle, p_old_name, (lustrefsal_handle_t *)p_new_parentdir_handle, p_new_name, 
					 (lustrefsal_op_context_t *)p_context, p_src_dir_attributes, p_tgt_dir_attributes ) ;
}
...
{
  return LUSTREFSAL_readlink( (lustrefsal_handle_t *)p_linkhandle, (lustrefsal_op_context_t *)p_context, p_link_content, p_link_attributes ) ;
}
...
fsal_status_t WRAP_LUSTREFSAL_symlink(fsal_handle_t * p_parent_directory_handle,   /* IN */
                           ...
                           fsal_attrib_list_t * p_link_attributes       /* [ IN/OUT ] */) 
{
  return LUSTREFSAL_symlink( (lustrefsal_handle_t *)p_parent_directory_handle, p_linkname, p_linkcontent, 
					  (lustrefsal_op_context_t *)p_context, accessmode, (lustrefsal_handle_t *)p_link_handle, p_link_attributes ) ;
}

int WRAP_LUSTREFSAL_handlecmp(fsal_handle_t * handle1, fsal_handle_t * handle2,
                   fsal_status_t * status) 
{
  return LUSTREFSAL_handlecmp( (lustrefsal_handle_t *)handle1, (lustrefsal_handle_t *)handle2, status ) ;
}
...
{
  return LUSTREFSAL_Handle_to_HashIndex( (lustrefsal_handle_t *)p_handle, cookie, alphabet_len, index_size ) ;
}

unsigned int WRAP_LUSTREFSAL_Handle_to_RBTIndex(fsal_handle_t * p_handle, unsigned int cookie)
{
...
{
  return LUSTREFSAL_DigestHandle( (lustrefsal_export_context_t *)p_exportcontext, output_type, (lustrefsal_handle_t *)p_in_fsal_handle, out_buff ) ;
}
...
{
  return LUSTREFSAL_ExpandHandle( (lustrefsal_export_context_t *)p_expcontext, in_type, in_buff, (lustrefsal_handle_t *)p_out_fsal_handle ) ;
}
...
fsal_status_t WRAP_LUSTREFSAL_SetDefault_FS_common_parameter(fsal_parameter_t * out_parameter)
{
  return LUSTREFSAL_SetDefault_FS_common_parameter( out_parameter ) ;
}

fsal_status_t WRAP_LUSTREFSAL_SetDefault_FS_specific_parameter(fsal_parameter_t * out_parameter)
{
...
fsal_status_t WRAP_LUSTREFSAL_load_FS_specific_parameter_from_conf(config_file_t in_config,
                                                        fsal_parameter_t * out_parameter)
{
...
{
  return LUSTREFSAL_truncate( (lustrefsal_handle_t *)p_filehandle, (lustrefsal_op_context_t *)p_context, length, 
...
{
  return LUSTREFSAL_unlink( (lustrefsal_handle_t *)p_parent_directory_handle, p_object_name, (lustrefsal_op_context_t *)p_context, p_parent_directory_attributes ) ;
} 
...
{
  return LUSTREFSAL_GetXAttrAttrs( (lustrefsal_handle_t *)p_objecthandle, (lustrefsal_op_context_t *)p_context, xattr_id, p_attrs ) ;
}
...
fsal_status_t WRAP_LUSTREFSAL_ListXAttrs(fsal_handle_t * p_objecthandle,   /* IN */
                              ...
                              int *end_of_list  /* OUT */ ) 
{
  return LUSTREFSAL_ListXAttrs( (lustrefsal_handle_t *)p_objecthandle, cookie, (lustrefsal_op_context_t *)p_context,
...
{
  return LUSTREFSAL_GetXAttrValueById( (lustrefsal_handle_t *)p_objecthandle, xattr_id, (lustrefsal_op_context_t *)p_context, 
...
{
  return LUSTREFSAL_GetXAttrIdByName( (lustrefsal_handle_t *)p_objecthandle, xattr_name, (lustrefsal_op_context_t *)p_context, pxattr_id ) ;
}
...
{
  return LUSTREFSAL_GetXAttrValueByName( (lustrefsal_handle_t *)p_objecthandle, xattr_name, (lustrefsal_op_context_t *)p_context,
						      buffer_addr, buffer_size, p_output_size ) ;
}
...
fsal_status_t WRAP_LUSTREFSAL_SetXAttrValue(fsal_handle_t * p_objecthandle,        /* IN */
                                 ...
                                 int create     /* IN */) 
{
  return LUSTREFSAL_SetXAttrValue( (lustrefsal_handle_t *)p_objecthandle, xattr_name, (lustrefsal_op_context_t *)p_context,
...
fsal_status_t WRAP_LUSTREFSAL_SetXAttrValueById(fsal_handle_t * p_objecthandle,    /* IN */
                                     ...
                                     size_t buffer_size /* IN */ ) 
{
  return LUSTREFSAL_SetXAttrValueById( (lustrefsal_handle_t *)p_objecthandle, xattr_id, (lustrefsal_op_context_t *)p_context,
...
fsal_status_t WRAP_LUSTREFSAL_RemoveXAttrById(fsal_handle_t * p_objecthandle,      /* IN */
                                   ...
                                   unsigned int xattr_id)       /* IN */
{
  return LUSTREFSAL_RemoveXAttrById( (lustrefsal_handle_t *)p_objecthandle, (lustrefsal_op_context_t *)p_context, xattr_id ) ;
}
...
{
  return LUSTREFSAL_RemoveXAttrByName( (lustrefsal_handle_t *)p_objecthandle, (lustrefsal_op_context_t *)p_context, xattr_name ) ;
}
...
fsal_functions_t fsal_lustre_functions = {
  ...
  .fsal_setdefault_fs_specific_parameter = WRAP_LUSTREFSAL_SetDefault_FS_specific_parameter,
  .fsal_load_fsal_parameter_from_conf = WRAP_LUSTREFSAL_load_FSAL_parameter_from_conf,
  .fsal_load_fs_common_parameter_from_conf = WRAP_LUSTREFSAL_load_FS_common_parameter_from_conf,
  .fsal_load_fs_specific_parameter_from_conf = WRAP_LUSTREFSAL_load_FS_specific_parameter_from_conf,
