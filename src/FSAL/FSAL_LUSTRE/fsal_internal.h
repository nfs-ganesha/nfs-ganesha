...
fsal_status_t LUSTREFSAL_unlock(lustrefsal_file_t * obj_handle, lustrefsal_lockdesc_t * ldesc) ;

fsal_status_t LUSTREFSAL_getlock(lustrefsal_file_t * obj_handle, lustrefsal_lockdesc_t * ldesc) ;
