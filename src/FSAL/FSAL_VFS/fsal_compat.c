...
fsal_functions_t fsal_vfs_functions = {
  ...
  .fsal_initclientcontext = VFSFSAL_InitClientContext,
  .fsal_getclientcontext = VFSFSAL_GetClientContext,
  ...
  .fsal_open_by_fileid = VFSFSAL_open_by_fileid,
  .fsal_close_by_fileid = VFSFSAL_close_by_fileid,
  ...
  .fsal_setattr_access = VFSFSAL_setattr_access,
  .fsal_rename_access = VFSFSAL_rename_access,
  .fsal_create_access = VFSFSAL_create_access,
  .fsal_unlink_access = VFSFSAL_unlink_access,
  .fsal_link_access = VFSFSAL_link_access,
  .fsal_merge_attrs = VFSFSAL_merge_attrs,
  ...
  .fsal_getlock = VFSFSAL_getlock,
  .fsal_cleanobjectresources = VFSFSAL_CleanObjectResources,
  .fsal_set_quota = VFSFSAL_set_quota,
  .fsal_get_quota = VFSFSAL_get_quota,
  .fsal_rcp = VFSFSAL_rcp,
  .fsal_rcp_by_fileid = VFSFSAL_rcp_by_fileid,
