...
fsal_functions_t fsal_fuse_functions = {
  ...
  .fsal_cleanupexportcontext = FUSEFSAL_CleanUpExportContext,
  ...
  .fsal_open_by_fileid = FUSEFSAL_open_by_fileid,
  .fsal_close_by_fileid = FUSEFSAL_close_by_fileid,
  .fsal_static_fsinfo = FUSEFSAL_static_fsinfo,
  ...
  .fsal_lock = FUSEFSAL_lock,
  .fsal_changelock = FUSEFSAL_changelock,
  .fsal_unlock = FUSEFSAL_unlock,
  .fsal_getlock = FUSEFSAL_getlock,
  .fsal_cleanobjectresources = FUSEFSAL_CleanObjectResources,
  .fsal_set_quota = FUSEFSAL_set_quota,
  .fsal_get_quota = FUSEFSAL_get_quota,
  .fsal_rcp = FUSEFSAL_rcp,
  .fsal_rcp_by_fileid = FUSEFSAL_rcp_by_fileid,
