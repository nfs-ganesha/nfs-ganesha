...
{
  return FUSEFSAL_access( (fusefsal_handle_t *)object_handle, (fusefsal_op_context_t *)p_context, access_type, object_attributes ) ;
}
...
{
  return FUSEFSAL_getattrs( (fusefsal_handle_t *)p_filehandle, (fusefsal_op_context_t *)p_context, p_object_attributes ) ;
}
...
fsal_status_t WRAP_FUSEFSAL_setattrs(fsal_handle_t * p_filehandle,       /* IN */
                            ...
                            fsal_attrib_list_t * p_object_attributes    /* [ IN/OUT ] */)
{
  return FUSEFSAL_setattrs( (fusefsal_handle_t *)p_filehandle, (fusefsal_op_context_t *)p_context, p_attrib_set, p_object_attributes ) ;
}
...
{
  return FUSEFSAL_BuildExportContext( (fusefsal_export_context_t *)p_export_context, p_export_path, fs_specific_options ) ;
}
...
{
  return FUSEFSAL_GetClientContext( (fusefsal_op_context_t *)p_thr_context, (fusefsal_export_context_t *)p_export_context, uid, gid, alt_groups, nb_alt_groups ) ;
}
...
fsal_status_t WRAP_FUSEFSAL_create(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */ ) 
{
  return FUSEFSAL_create( (fusefsal_handle_t *) p_parent_directory_handle, p_filename, (fusefsal_op_context_t *)p_context,
			   accessmode, (fusefsal_handle_t *)p_object_handle, p_object_attributes ) ;
}
...
fsal_status_t WRAP_FUSEFSAL_mkdir(fsal_handle_t * p_parent_directory_handle,     /* IN */
                         ...
                         fsal_attrib_list_t * p_object_attributes       /* [ IN/OUT ] */)
{
  return FUSEFSAL_mkdir( (fusefsal_handle_t *)p_parent_directory_handle, p_dirname, (fusefsal_op_context_t *)p_context,
					accessmode, (fusefsal_handle_t *)p_object_handle, p_object_attributes ) ;
}
...
{
  return FUSEFSAL_link( (fusefsal_handle_t *)p_target_handle, (fusefsal_handle_t *)p_dir_handle, p_link_name, (fusefsal_op_context_t *)p_context, p_attributes ) ;
}
...
{
  return FUSEFSAL_mknode( (fusefsal_handle_t *)parentdir_handle, p_node_name, (fusefsal_op_context_t *)p_context, accessmode,
					 nodetype, dev,   (fusefsal_handle_t *)p_object_handle, node_attributes ) ;
}
...
{
  return FUSEFSAL_opendir( (fusefsal_handle_t *)p_dir_handle, (fusefsal_op_context_t *)p_context, 
                           ...
                           fsal_boolean_t * p_end_of_dir        /* OUT */ ) 
{
  ...
  return FUSEFSAL_readdir( (fusefsal_dir_t *)p_dir_descriptor, fusecookie, get_attr_mask,
	     		  buffersize, p_pdirent, (fusefsal_cookie_t *)p_end_position, p_nb_entries, p_end_of_dir ) ;
}
                                ...
                                fsal_attrib_list_t * file_attributes /* [ IN/OUT ] */ )
{
  return FUSEFSAL_open_by_name( (fusefsal_handle_t *)dirhandle, filename, 
			       (fusefsal_op_context_t *)p_context, openflags, (fusefsal_file_t *)file_descriptor, file_attributes ) ;
}
...
{
  return FUSEFSAL_open( (fusefsal_handle_t *)p_filehandle, (fusefsal_op_context_t *)p_context, 
                       openflags, (fusefsal_file_t *)p_file_descriptor, p_file_attributes ) ;
}
...
{
  return FUSEFSAL_read( (fusefsal_file_t *)p_file_descriptor, p_seek_descriptor, buffer_size, buffer, p_read_amount, p_end_of_file ) ;
}
...
{
  return FUSEFSAL_write( (fusefsal_file_t *)p_file_descriptor, p_seek_descriptor, buffer_size, buffer, p_write_amount ) ;
}
...
fsal_status_t WRAP_FUSEFSAL_open_by_fileid(fsal_handle_t * filehandle,   /* IN */
                                  ...
                                  fsal_attrib_list_t * file_attributes /* [ IN/OUT ] */ )
{
   return FUSEFSAL_open_by_fileid( (fusefsal_handle_t *)filehandle, fileid, (fusefsal_op_context_t *)p_context, 
                                   openflags, (fusefsal_file_t *)file_descriptor, file_attributes ) ;
}
...
{
  return FUSEFSAL_static_fsinfo( (fusefsal_handle_t *)p_filehandle, (fusefsal_op_context_t *)p_context, p_staticinfo ) ;
}
...
{
  return FUSEFSAL_dynamic_fsinfo( (fusefsal_handle_t *)p_filehandle, (fusefsal_op_context_t *)p_context, p_dynamicinfo ) ;
}
...
{
  return FUSEFSAL_test_access( (fusefsal_op_context_t *)p_context, access_type, p_object_attributes ) ;
}
...
{
  return FUSEFSAL_setattr_access( (fusefsal_op_context_t *)p_context, candidate_attributes, object_attributes ) ;
}
...
fsal_status_t WRAP_FUSEFSAL_lookup(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */)
{
  return FUSEFSAL_lookup( (fusefsal_handle_t *)p_parent_directory_handle, p_filename, (fusefsal_op_context_t *)p_context,
...
fsal_status_t WRAP_FUSEFSAL_lookupPath(fsal_path_t * p_path,     /* IN */
                              ...
                              fsal_attrib_list_t * p_object_attributes  /* [ IN/OUT ] */)
{
  return FUSEFSAL_lookupPath( p_path, (fusefsal_op_context_t *)p_context, (fusefsal_handle_t *)object_handle, p_object_attributes ) ;
}
...
{  
  return FUSEFSAL_lookupJunction( (fusefsal_handle_t *)p_junction_handle, (fusefsal_op_context_t *)p_context, (fusefsal_handle_t *)p_fsoot_handle, p_fsroot_attributes ) ;
}

fsal_status_t WRAP_FUSEFSAL_lock(fsal_file_t * obj_handle,
                        fsal_lockdesc_t * ldesc, fsal_boolean_t blocking)
{
  return FUSEFSAL_lock( (fusefsal_file_t *)obj_handle, (fusefsal_lockdesc_t *)ldesc, blocking ) ;
}
...
{
  return FUSEFSAL_rcp( (fusefsal_handle_t *)filehandle, (fusefsal_op_context_t *)p_context, p_local_path, transfer_opt ) ;
}
...
fsal_status_t WRAP_FUSEFSAL_rcp_by_fileid(fsal_handle_t * filehandle,    /* IN */
                                 ...
                                 fsal_rcpflag_t transfer_opt /* IN */ ) 
{
  return FUSEFSAL_rcp_by_fileid( (fusefsal_handle_t *)filehandle, fileid, (fusefsal_op_context_t *)p_context, p_local_path, transfer_opt ) ;
}
...
{
  return FUSEFSAL_rename( (fusefsal_handle_t *)p_old_parentdir_handle, p_old_name, (fusefsal_handle_t *)p_new_parentdir_handle, p_new_name, 
					 (fusefsal_op_context_t *)p_context, p_src_dir_attributes, p_tgt_dir_attributes ) ;
}
...
{
  return FUSEFSAL_readlink( (fusefsal_handle_t *)p_linkhandle, (fusefsal_op_context_t *)p_context, p_link_content, p_link_attributes ) ;
}
...
fsal_status_t WRAP_FUSEFSAL_symlink(fsal_handle_t * p_parent_directory_handle,   /* IN */
                           ...
                           fsal_attrib_list_t * p_link_attributes       /* [ IN/OUT ] */) 
{
  return FUSEFSAL_symlink( (fusefsal_handle_t *)p_parent_directory_handle, p_linkname, p_linkcontent, 
					  (fusefsal_op_context_t *)p_context, accessmode, (fusefsal_handle_t *)p_link_handle, p_link_attributes ) ;
}

int WRAP_FUSEFSAL_handlecmp(fsal_handle_t * handle1, fsal_handle_t * handle2,
                   fsal_status_t * status) 
{
  return FUSEFSAL_handlecmp( (fusefsal_handle_t *)handle1, (fusefsal_handle_t *)handle2, status ) ;
}
...
{
  return FUSEFSAL_Handle_to_HashIndex( (fusefsal_handle_t *)p_handle, cookie, alphabet_len, index_size ) ;
}

unsigned int WRAP_FUSEFSAL_Handle_to_RBTIndex(fsal_handle_t * p_handle, unsigned int cookie)
{
...
{
  return FUSEFSAL_DigestHandle( (fusefsal_export_context_t *)p_exportcontext, output_type, (fusefsal_handle_t *)p_in_fsal_handle, out_buff ) ;
}
...
{
  return FUSEFSAL_ExpandHandle( (fusefsal_export_context_t *)p_expcontext, in_type, in_buff, (fusefsal_handle_t *)p_out_fsal_handle ) ;
}
...
fsal_status_t WRAP_FUSEFSAL_SetDefault_FS_common_parameter(fsal_parameter_t * out_parameter)
{
  return FUSEFSAL_SetDefault_FS_common_parameter( out_parameter ) ;
}

fsal_status_t WRAP_FUSEFSAL_SetDefault_FS_specific_parameter(fsal_parameter_t * out_parameter)
{
...
{
  return FUSEFSAL_truncate( (fusefsal_handle_t *)p_filehandle, (fusefsal_op_context_t *)p_context, length, 
...
{
  return FUSEFSAL_unlink( (fusefsal_handle_t *)p_parent_directory_handle, p_object_name, (fusefsal_op_context_t *)p_context, p_parent_directory_attributes ) ;
} 
...
{
  return FUSEFSAL_GetXAttrAttrs( (fusefsal_handle_t *)p_objecthandle, (fusefsal_op_context_t *)p_context, xattr_id, p_attrs ) ;
}
...
fsal_status_t WRAP_FUSEFSAL_ListXAttrs(fsal_handle_t * p_objecthandle,   /* IN */
                              ...
                              int *end_of_list  /* OUT */ ) 
{
  return FUSEFSAL_ListXAttrs( (fusefsal_handle_t *)p_objecthandle, cookie, (fusefsal_op_context_t *)p_context,
...
{
  return FUSEFSAL_GetXAttrValueById( (fusefsal_handle_t *)p_objecthandle, xattr_id, (fusefsal_op_context_t *)p_context, 
...
{
  return FUSEFSAL_GetXAttrIdByName( (fusefsal_handle_t *)p_objecthandle, xattr_name, (fusefsal_op_context_t *)p_context, pxattr_id ) ;
}
...
{
  return FUSEFSAL_GetXAttrValueByName( (fusefsal_handle_t *)p_objecthandle, xattr_name, (fusefsal_op_context_t *)p_context,
						      buffer_addr, buffer_size, p_output_size ) ;
}
...
fsal_status_t WRAP_FUSEFSAL_SetXAttrValue(fsal_handle_t * p_objecthandle,        /* IN */
                                 ...
                                 int create     /* IN */) 
{
  return FUSEFSAL_SetXAttrValue( (fusefsal_handle_t *)p_objecthandle, xattr_name, (fusefsal_op_context_t *)p_context,
...
fsal_status_t WRAP_FUSEFSAL_SetXAttrValueById(fsal_handle_t * p_objecthandle,    /* IN */
                                     ...
                                     size_t buffer_size /* IN */ ) 
{
  return FUSEFSAL_SetXAttrValueById( (fusefsal_handle_t *)p_objecthandle, xattr_id, (fusefsal_op_context_t *)p_context,
...
fsal_status_t WRAP_FUSEFSAL_RemoveXAttrById(fsal_handle_t * p_objecthandle,      /* IN */
                                   ...
                                   unsigned int xattr_id)       /* IN */
{
  return FUSEFSAL_RemoveXAttrById( (fusefsal_handle_t *)p_objecthandle, (fusefsal_op_context_t *)p_context, xattr_id ) ;
}
...
{
  return FUSEFSAL_RemoveXAttrByName( (fusefsal_handle_t *)p_objecthandle, (fusefsal_op_context_t *)p_context, xattr_name ) ;
}
...
fsal_functions_t fsal_fuse_functions = {
  ...
  .fsal_load_fs_common_parameter_from_conf = WRAP_FUSEFSAL_load_FS_common_parameter_from_conf,
  .fsal_load_fs_specific_parameter_from_conf = WRAP_FUSEFSAL_load_FS_specific_parameter_from_conf,
