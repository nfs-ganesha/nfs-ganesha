...
{
  return HPSSFSAL_access( (hpssfsal_handle_t *)object_handle, (hpssfsal_op_context_t *)p_context, access_type, object_attributes ) ;
}
...
{
  return HPSSFSAL_getattrs( (hpssfsal_handle_t *)p_filehandle, (hpssfsal_op_context_t *)p_context, p_object_attributes ) ;
}
...
fsal_status_t WRAP_HPSSFSAL_setattrs(fsal_handle_t * p_filehandle,       /* IN */
                            ...
                            fsal_attrib_list_t * p_object_attributes    /* [ IN/OUT ] */)
{
  return HPSSFSAL_setattrs( (hpssfsal_handle_t *)p_filehandle, (hpssfsal_op_context_t *)p_context, p_attrib_set, p_object_attributes ) ;
}
...
{
  return HPSSFSAL_BuildExportContext( (hpssfsal_export_context_t *)p_export_context, p_export_path, fs_specific_options ) ;
}
...
{
  return HPSSFSAL_GetClientContext( (hpssfsal_op_context_t *)p_thr_context, (hpssfsal_export_context_t *)p_export_context, uid, gid, alt_groups, nb_alt_groups ) ;
}
...
fsal_status_t WRAP_HPSSFSAL_create(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */ ) 
{
  return HPSSFSAL_create( (hpssfsal_handle_t *) p_parent_directory_handle, p_filename, (hpssfsal_op_context_t *)p_context,
			   accessmode, (hpssfsal_handle_t *)p_object_handle, p_object_attributes ) ;
}
...
fsal_status_t WRAP_HPSSFSAL_mkdir(fsal_handle_t * p_parent_directory_handle,     /* IN */
                         ...
                         fsal_attrib_list_t * p_object_attributes       /* [ IN/OUT ] */)
{
  return HPSSFSAL_mkdir( (hpssfsal_handle_t *)p_parent_directory_handle, p_dirname, (hpssfsal_op_context_t *)p_context,
					accessmode, (hpssfsal_handle_t *)p_object_handle, p_object_attributes ) ;
}
...
{
  return HPSSFSAL_link( (hpssfsal_handle_t *)p_target_handle, (hpssfsal_handle_t *)p_dir_handle, p_link_name, (hpssfsal_op_context_t *)p_context, p_attributes ) ;
}
...
{
  return HPSSFSAL_mknode( (hpssfsal_handle_t *)parentdir_handle, p_node_name, (hpssfsal_op_context_t *)p_context, accessmode,
					 nodetype, dev,   (hpssfsal_handle_t *)p_object_handle, node_attributes ) ;
}
...
{
  return HPSSFSAL_opendir( (hpssfsal_handle_t *)p_dir_handle, (hpssfsal_op_context_t *)p_context, 
                           ...
                           fsal_boolean_t * p_end_of_dir        /* OUT */ ) 
{
  ...
  return HPSSFSAL_readdir( (hpssfsal_dir_t *)p_dir_descriptor, hpsscookie, get_attr_mask,
	     		  buffersize, p_pdirent, (hpssfsal_cookie_t *)p_end_position, p_nb_entries, p_end_of_dir ) ;
}
                                ...
                                fsal_attrib_list_t * file_attributes /* [ IN/OUT ] */ )
{
  return HPSSFSAL_open_by_name( (hpssfsal_handle_t *)dirhandle, filename, 
			       (hpssfsal_op_context_t *)p_context, openflags, (hpssfsal_file_t *)file_descriptor, file_attributes ) ;
}
...
{
  return HPSSFSAL_open( (hpssfsal_handle_t *)p_filehandle, (hpssfsal_op_context_t *)p_context, 
                       openflags, (hpssfsal_file_t *)p_file_descriptor, p_file_attributes ) ;
}
...
{
  return HPSSFSAL_read( (hpssfsal_file_t *)p_file_descriptor, p_seek_descriptor, buffer_size, buffer, p_read_amount, p_end_of_file ) ;
}
...
{
  return HPSSFSAL_write( (hpssfsal_file_t *)p_file_descriptor, p_seek_descriptor, buffer_size, buffer, p_write_amount ) ;
}
...
fsal_status_t WRAP_HPSSFSAL_open_by_fileid(fsal_handle_t * filehandle,   /* IN */
                                  ...
                                  fsal_attrib_list_t * file_attributes /* [ IN/OUT ] */ )
{
   return HPSSFSAL_open_by_fileid( (hpssfsal_handle_t *)filehandle, fileid, (hpssfsal_op_context_t *)p_context, 
                                   openflags, (hpssfsal_file_t *)file_descriptor, file_attributes ) ;
}
...
{
  return HPSSFSAL_static_fsinfo( (hpssfsal_handle_t *)p_filehandle, (hpssfsal_op_context_t *)p_context, p_staticinfo ) ;
}
...
{
  return HPSSFSAL_dynamic_fsinfo( (hpssfsal_handle_t *)p_filehandle, (hpssfsal_op_context_t *)p_context, p_dynamicinfo ) ;
}
...
{
  return HPSSFSAL_test_access( (hpssfsal_op_context_t *)p_context, access_type, p_object_attributes ) ;
}
...
{
  return HPSSFSAL_setattr_access( (hpssfsal_op_context_t *)p_context, candidate_attributes, object_attributes ) ;
}
...
fsal_status_t WRAP_HPSSFSAL_lookup(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */)
{
  return HPSSFSAL_lookup( (hpssfsal_handle_t *)p_parent_directory_handle, p_filename, (hpssfsal_op_context_t *)p_context,
...
fsal_status_t WRAP_HPSSFSAL_lookupPath(fsal_path_t * p_path,     /* IN */
                              ...
                              fsal_attrib_list_t * p_object_attributes  /* [ IN/OUT ] */)
{
  return HPSSFSAL_lookupPath( p_path, (hpssfsal_op_context_t *)p_context, (hpssfsal_handle_t *)object_handle, p_object_attributes ) ;
}
...
{  
  return HPSSFSAL_lookupJunction( (hpssfsal_handle_t *)p_junction_handle, (hpssfsal_op_context_t *)p_context, (hpssfsal_handle_t *)p_fsoot_handle, p_fsroot_attributes ) ;
}

fsal_status_t WRAP_HPSSFSAL_lock(fsal_file_t * obj_handle,
                        fsal_lockdesc_t * ldesc, fsal_boolean_t blocking)
{
  return HPSSFSAL_lock( (hpssfsal_file_t *)obj_handle, (hpssfsal_lockdesc_t *)ldesc, blocking ) ;
}
...
{
  return HPSSFSAL_rcp( (hpssfsal_handle_t *)filehandle, (hpssfsal_op_context_t *)p_context, p_local_path, transfer_opt ) ;
}
...
fsal_status_t WRAP_HPSSFSAL_rcp_by_fileid(fsal_handle_t * filehandle,    /* IN */
                                 ...
                                 fsal_rcpflag_t transfer_opt /* IN */ ) 
{
  return HPSSFSAL_rcp_by_fileid( (hpssfsal_handle_t *)filehandle, fileid, (hpssfsal_op_context_t *)p_context, p_local_path, transfer_opt ) ;
}
...
{
  return HPSSFSAL_rename( (hpssfsal_handle_t *)p_old_parentdir_handle, p_old_name, (hpssfsal_handle_t *)p_new_parentdir_handle, p_new_name, 
					 (hpssfsal_op_context_t *)p_context, p_src_dir_attributes, p_tgt_dir_attributes ) ;
}
...
{
  return HPSSFSAL_readlink( (hpssfsal_handle_t *)p_linkhandle, (hpssfsal_op_context_t *)p_context, p_link_content, p_link_attributes ) ;
}
...
fsal_status_t WRAP_HPSSFSAL_symlink(fsal_handle_t * p_parent_directory_handle,   /* IN */
                           ...
                           fsal_attrib_list_t * p_link_attributes       /* [ IN/OUT ] */) 
{
  return HPSSFSAL_symlink( (hpssfsal_handle_t *)p_parent_directory_handle, p_linkname, p_linkcontent, 
					  (hpssfsal_op_context_t *)p_context, accessmode, (hpssfsal_handle_t *)p_link_handle, p_link_attributes ) ;
}

int WRAP_HPSSFSAL_handlecmp(fsal_handle_t * handle1, fsal_handle_t * handle2,
                   fsal_status_t * status) 
{
  return HPSSFSAL_handlecmp( (hpssfsal_handle_t *)handle1, (hpssfsal_handle_t *)handle2, status ) ;
}
...
{
  return HPSSFSAL_Handle_to_HashIndex( (hpssfsal_handle_t *)p_handle, cookie, alphabet_len, index_size ) ;
}
...
{
  return HPSSFSAL_DigestHandle( (hpssfsal_export_context_t *)p_exportcontext, output_type, (hpssfsal_handle_t *)p_in_fsal_handle, out_buff ) ;
}
...
{
  return HPSSFSAL_ExpandHandle( (hpssfsal_export_context_t *)p_expcontext, in_type, in_buff, (hpssfsal_handle_t *)p_out_fsal_handle ) ;
}
...
{
  return HPSSFSAL_truncate( (hpssfsal_handle_t *)p_filehandle, (hpssfsal_op_context_t *)p_context, length, 
...
{
  return HPSSFSAL_unlink( (hpssfsal_handle_t *)p_parent_directory_handle, p_object_name, (hpssfsal_op_context_t *)p_context, p_parent_directory_attributes ) ;
} 
...
{
  return HPSSFSAL_GetXAttrAttrs( (hpssfsal_handle_t *)p_objecthandle, (hpssfsal_op_context_t *)p_context, xattr_id, p_attrs ) ;
}
...
fsal_status_t WRAP_HPSSFSAL_ListXAttrs(fsal_handle_t * p_objecthandle,   /* IN */
                              ...
                              int *end_of_list  /* OUT */ ) 
{
  return HPSSFSAL_ListXAttrs( (hpssfsal_handle_t *)p_objecthandle, cookie, (hpssfsal_op_context_t *)p_context,
...
{
  return HPSSFSAL_GetXAttrValueById( (hpssfsal_handle_t *)p_objecthandle, xattr_id, (hpssfsal_op_context_t *)p_context, 
...
{
  return HPSSFSAL_GetXAttrIdByName( (hpssfsal_handle_t *)p_objecthandle, xattr_name, (hpssfsal_op_context_t *)p_context, pxattr_id ) ;
}
...
{
  return HPSSFSAL_GetXAttrValueByName( (hpssfsal_handle_t *)p_objecthandle, xattr_name, (hpssfsal_op_context_t *)p_context,
						      buffer_addr, buffer_size, p_output_size ) ;
}
...
fsal_status_t WRAP_HPSSFSAL_SetXAttrValue(fsal_handle_t * p_objecthandle,        /* IN */
                                 ...
                                 int create     /* IN */) 
{
  return HPSSFSAL_SetXAttrValue( (hpssfsal_handle_t *)p_objecthandle, xattr_name, (hpssfsal_op_context_t *)p_context,
...
fsal_status_t WRAP_HPSSFSAL_SetXAttrValueById(fsal_handle_t * p_objecthandle,    /* IN */
                                     ...
                                     size_t buffer_size /* IN */ ) 
{
  return HPSSFSAL_SetXAttrValueById( (hpssfsal_handle_t *)p_objecthandle, xattr_id, (hpssfsal_op_context_t *)p_context,
...
fsal_status_t WRAP_HPSSFSAL_RemoveXAttrById(fsal_handle_t * p_objecthandle,      /* IN */
                                   ...
                                   unsigned int xattr_id)       /* IN */
{
  return HPSSFSAL_RemoveXAttrById( (hpssfsal_handle_t *)p_objecthandle, (hpssfsal_op_context_t *)p_context, xattr_id ) ;
}
...
{
  return HPSSFSAL_RemoveXAttrByName( (hpssfsal_handle_t *)p_objecthandle, (hpssfsal_op_context_t *)p_context, xattr_name ) ;
}
...
fsal_functions_t fsal_hpss_functions = {
  ...
  .fsal_load_fs_common_parameter_from_conf = WRAP_HPSSFSAL_load_FS_common_parameter_from_conf,
  .fsal_load_fs_specific_parameter_from_conf = WRAP_HPSSFSAL_load_FS_specific_parameter_from_conf,
