...
inline fsal_status_t WRAP_XFSFSAL_create(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */ ) 
{
  return XFSFSAL_create( (xfsfsal_handle_t *) p_parent_directory_handle, p_filename, (xfsfsal_op_context_t *)p_context,
...
inline fsal_status_t WRAP_XFSFSAL_mkdir(fsal_handle_t * p_parent_directory_handle,     /* IN */
                         ...
                         fsal_attrib_list_t * p_object_attributes       /* [ IN/OUT ] */)
{
  return XFSFSAL_mkdir( (xfsfsal_handle_t *)p_parent_directory_handle, p_dirname, (xfsfsal_op_context_t *)p_context,
					accessmode, (xfsfsal_handle_t *)p_object_handle, p_object_attributes ) ;
}
...
{
  return XFSFSAL_mknode( (xfsfsal_handle_t *)parentdir_handle, p_node_name, (xfsfsal_op_context_t *)p_context, accessmode,
					 nodetype, dev,   (xfsfsal_handle_t *)p_object_handle, node_attributes ) ;
}
...
inline fsal_status_t WRAP_XFSFSAL_lookup(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */)
{
  return XFSFSAL_lookup( (xfsfsal_handle_t *)p_parent_directory_handle, p_filename, (xfsfsal_op_context_t *)p_context,
...
{
  return XFSFSAL_rename( (xfsfsal_handle_t *)p_old_parentdir_handle, p_old_name, (xfsfsal_handle_t *)p_new_parentdir_handle, p_new_name, 
...
inline fsal_status_t WRAP_XFSFSAL_symlink(fsal_handle_t * p_parent_directory_handle,   /* IN */
                           ...
                           fsal_attrib_list_t * p_link_attributes       /* [ IN/OUT ] */) 
{
  return XFSFSAL_symlink( (xfsfsal_handle_t *)p_parent_directory_handle, p_linkname, p_linkcontent, 
...
inline fsal_status_t WRAP_XFSFSAL_ListXAttrs(fsal_handle_t * p_objecthandle,   /* IN */
                              ...
                              int *end_of_list  /* OUT */ ) 
{
  return XFSFSAL_ListXAttrs( (xfsfsal_handle_t *)p_objecthandle, cookie, (xfsfsal_op_context_t *)p_context,
...
{
  return XFSFSAL_GetXAttrValueById( (xfsfsal_handle_t *)p_objecthandle, xattr_id, (xfsfsal_op_context_t *)p_context, 
...
{
  return XFSFSAL_GetXAttrValueByName( (xfsfsal_handle_t *)p_objecthandle, xattr_name, (xfsfsal_op_context_t *)p_context,
						      buffer_addr, buffer_size, p_output_size ) ;
}
...
inline fsal_status_t WRAP_XFSFSAL_SetXAttrValue(fsal_handle_t * p_objecthandle,        /* IN */
                                 ...
                                 int create     /* IN */) 
{
  return XFSFSAL_SetXAttrValue( (xfsfsal_handle_t *)p_objecthandle, xattr_name, (xfsfsal_op_context_t *)p_context,
...
inline fsal_status_t WRAP_XFSFSAL_SetXAttrValueById(fsal_handle_t * p_objecthandle,    /* IN */
                                     ...
                                     size_t buffer_size /* IN */ ) 
{
  return XFSFSAL_SetXAttrValueById( (xfsfsal_handle_t *)p_objecthandle, xattr_id, (xfsfsal_op_context_t *)p_context,
...
{
  return XFSFSAL_RemoveXAttrByName( (xfsfsal_handle_t *)p_objecthandle, (xfsfsal_op_context_t *)p_context, xattr_name ) ;
}
...
fsal_functions_t fsal_xfs_functions = {
  ...
  .fsal_load_fs_common_parameter_from_conf = WRAP_XFSFSAL_load_FS_common_parameter_from_conf,
  .fsal_load_fs_specific_parameter_from_conf = WRAP_XFSFSAL_load_FS_specific_parameter_from_conf,
