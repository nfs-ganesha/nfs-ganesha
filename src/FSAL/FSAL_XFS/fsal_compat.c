...
fsal_functions_t fsal_xfs_functions = {
  ...
  .fsal_rcp_by_fileid = XFSFSAL_rcp_by_fileid           ,
  ...
  .fsal_load_fs_common_parameter_from_conf = XFSFSAL_load_FS_common_parameter_from_conf,
  .fsal_load_fs_specific_parameter_from_conf = XFSFSAL_load_FS_specific_parameter_from_conf,
