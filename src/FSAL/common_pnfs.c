...
/**
 *
 * xdr_fsal_deviceid: Encode an fsal_deviceid_t
 *
...
/**
 *
 * FSAL_encode_ipv4_netaddr: Encode most IPv4 netaddrs
 *
...
/**
 *
 * make_file_handle_v4: Internal function to convert file handles
 *
 ...
 *
 */
static nfsstat4 make_file_handle_v4(fsal_handle_t *fsal_handle,
...
/**
 *
 * fh4_dshandle: Convert an FSAL handle to an nfs_fh4 DS handle
 *
                           ...
                           nfs_fh4 *wirehandle)
{
  ...
  return
    make_file_handle_v4(fsal_handle,
                        export_id,
                        export,
...
/**
 *
 * FSAL_encode_file_layout: Convenience function to encode loc_body
 *
...
/**
 *
 * FSAL_encode_v4_multipath: Convenience function to encode one multipath_list
 *
