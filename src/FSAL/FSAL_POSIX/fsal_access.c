...
fsal_status_t FSAL_access(
  ...
  if ( p_object_attributes ){
    ...
    FSAL_SET_MASK( p_object_attributes->asked_attributes, FSAL_ATTR_OWNER | FSAL_ATTR_GROUP | FSAL_ATTR_ACL | FSAL_ATTR_MODE);
  ...
  } else { /* p_object_attributes is NULL */
    fsal_attrib_list_t attrs;
    
    FSAL_CLEAR_MASK( attrs.asked_attributes );
    FSAL_SET_MASK( attrs.asked_attributes, FSAL_ATTR_OWNER | FSAL_ATTR_GROUP | FSAL_ATTR_ACL | FSAL_ATTR_MODE);
