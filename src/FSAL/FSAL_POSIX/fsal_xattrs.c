...
int get_fsalid( fsal_handle_t     * p_objecthandle,  /* IN */
...
int print_fsalid( caddr_t    InBuff, 
                  size_t     InSize,
                  caddr_t    OutBuff, 
                  size_t   * pOutSize )
{
...
int get_timestamp( fsal_handle_t     * p_objecthandle,  /* IN */
                   fsal_op_context_t * p_context,       /* IN */
                   caddr_t             buffer_addr,     /* IN/OUT */
                   size_t              buffer_size,     /* IN */
                   size_t            * p_output_size )  /* OUT */
...
int print_timestamp( caddr_t    InBuff, 
                     size_t     InSize,
                     caddr_t    OutBuff, 
                     size_t   * pOutSize )
{
...
int get_deviceid( fsal_handle_t     * p_objecthandle,  /* IN */
                   fsal_op_context_t * p_context,       /* IN */
                   caddr_t             buffer_addr,     /* IN/OUT */
                   size_t              buffer_size,     /* IN */
                   size_t            * p_output_size )  /* OUT */
{
  ...
  status = fsal_internal_getPathFromHandle(p_context, p_objecthandle, 0, &fsalpath, &buffstat);
...
int print_deviceid( caddr_t    InBuff, 
                  size_t     InSize,
                  caddr_t    OutBuff, 
                  size_t   * pOutSize )
{
...
int get_inode( fsal_handle_t     * p_objecthandle,  /* IN */
               fsal_op_context_t * p_context,       /* IN */
               caddr_t             buffer_addr,     /* IN/OUT */
               size_t              buffer_size,     /* IN */
               size_t            * p_output_size )  /* OUT */
...
int print_inode( caddr_t    InBuff, 
                 size_t     InSize,
                 caddr_t    OutBuff, 
                 size_t   * pOutSize )
{
...
int get_objtype( fsal_handle_t     * p_objecthandle,  /* IN */
              fsal_op_context_t * p_context,       /* IN */
              caddr_t             buffer_addr,     /* IN/OUT */
              size_t              buffer_size,     /* IN */
              size_t            * p_output_size )  /* OUT */
...
int get_path( fsal_handle_t     * p_objecthandle,  /* IN */
              fsal_op_context_t * p_context,       /* IN */
              caddr_t             buffer_addr,     /* IN/OUT */
              size_t              buffer_size,     /* IN */
              size_t            * p_output_size )  /* OUT */
