...
fsal_functions_t fsal_xfs_functions = {
  ...
  .fsal_getclientcontext = POSIXFSAL_GetClientContext,
  ...
  .fsal_open_by_fileid = POSIXFSAL_open_by_fileid,
  .fsal_close_by_fileid = POSIXFSAL_close_by_fileid,
  .fsal_static_fsinfo = POSIXFSAL_static_fsinfo,
  ...
  .fsal_setattr_access = POSIXFSAL_setattr_access,
  .fsal_rename_access = POSIXFSAL_rename_access,
  .fsal_create_access = POSIXFSAL_create_access,
  .fsal_unlink_access = POSIXFSAL_unlink_access,
  .fsal_link_access = POSIXFSAL_link_access,
  .fsal_merge_attrs = POSIXFSAL_merge_attrs,
  .fsal_lookup = POSIXFSAL_lookup,
  .fsal_lookuppath = POSIXFSAL_lookupPath,
  .fsal_lookupjunction = POSIXFSAL_lookupJunction,
  .fsal_lock = POSIXFSAL_lock,
  .fsal_changelock = POSIXFSAL_changelock,
  .fsal_unlock = POSIXFSAL_unlock,
  .fsal_getlock = POSIXFSAL_getlock,
  .fsal_cleanobjectresources = POSIXFSAL_CleanObjectResources,
  .fsal_set_quota = POSIXFSAL_set_quota,
  .fsal_get_quota = POSIXFSAL_get_quota,
  .fsal_rcp = POSIXFSAL_rcp,
  .fsal_rcp_by_fileid = POSIXFSAL_rcp_by_fileid,
