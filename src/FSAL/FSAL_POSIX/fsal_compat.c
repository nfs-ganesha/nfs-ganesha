...
{
  return POSIXFSAL_access( (posixfsal_handle_t *)object_handle, (posixfsal_op_context_t *)p_context, access_type, object_attributes ) ;
}
...
{
  return POSIXFSAL_getattrs( (posixfsal_handle_t *)p_filehandle, (posixfsal_op_context_t *)p_context, p_object_attributes ) ;
}
...
fsal_status_t WRAP_POSIXFSAL_setattrs(fsal_handle_t * p_filehandle,       /* IN */
                            ...
                            fsal_attrib_list_t * p_object_attributes    /* [ IN/OUT ] */)
{
  return POSIXFSAL_setattrs( (posixfsal_handle_t *)p_filehandle, (posixfsal_op_context_t *)p_context, p_attrib_set, p_object_attributes ) ;
}
...
{
  return POSIXFSAL_BuildExportContext( (posixfsal_export_context_t *)p_export_context, p_export_path, fs_specific_options ) ;
}
...
{
  return POSIXFSAL_GetClientContext( (posixfsal_op_context_t *)p_thr_context, (posixfsal_export_context_t *)p_export_context, uid, gid, alt_groups, nb_alt_groups ) ;
}
...
fsal_status_t WRAP_POSIXFSAL_create(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */ ) 
{
  return POSIXFSAL_create( (posixfsal_handle_t *) p_parent_directory_handle, p_filename, (posixfsal_op_context_t *)p_context,
			   accessmode, (posixfsal_handle_t *)p_object_handle, p_object_attributes ) ;
}
...
fsal_status_t WRAP_POSIXFSAL_mkdir(fsal_handle_t * p_parent_directory_handle,     /* IN */
                         ...
                         fsal_attrib_list_t * p_object_attributes       /* [ IN/OUT ] */)
{
  return POSIXFSAL_mkdir( (posixfsal_handle_t *)p_parent_directory_handle, p_dirname, (posixfsal_op_context_t *)p_context,
					accessmode, (posixfsal_handle_t *)p_object_handle, p_object_attributes ) ;
}
...
{
  return POSIXFSAL_link( (posixfsal_handle_t *)p_target_handle, (posixfsal_handle_t *)p_dir_handle, p_link_name, (posixfsal_op_context_t *)p_context, p_attributes ) ;
}
...
{
  return POSIXFSAL_mknode( (posixfsal_handle_t *)parentdir_handle, p_node_name, (posixfsal_op_context_t *)p_context, accessmode,
					 nodetype, dev,   (posixfsal_handle_t *)p_object_handle, node_attributes ) ;
}
...
{
  return POSIXFSAL_opendir( (posixfsal_handle_t *)p_dir_handle, (posixfsal_op_context_t *)p_context, 
                           ...
                           fsal_boolean_t * p_end_of_dir        /* OUT */ ) 
{
  ...
  return POSIXFSAL_readdir( (posixfsal_dir_t *)p_dir_descriptor, xfscookie, get_attr_mask,
	     		  buffersize, p_pdirent, (posixfsal_cookie_t *)p_end_position, p_nb_entries, p_end_of_dir ) ;
}
                                ...
                                fsal_attrib_list_t * file_attributes /* [ IN/OUT ] */ )
{
  return POSIXFSAL_open_by_name( (posixfsal_handle_t *)dirhandle, filename, 
			       (posixfsal_op_context_t *)p_context, openflags, (posixfsal_file_t *)file_descriptor, file_attributes ) ;
}
...
{
  return POSIXFSAL_open( (posixfsal_handle_t *)p_filehandle, (posixfsal_op_context_t *)p_context, 
                       openflags, (posixfsal_file_t *)p_file_descriptor, p_file_attributes ) ;
}
...
{
  return POSIXFSAL_read( (posixfsal_file_t *)p_file_descriptor, p_seek_descriptor, buffer_size, buffer, p_read_amount, p_end_of_file ) ;
}
...
{
  return POSIXFSAL_write( (posixfsal_file_t *)p_file_descriptor, p_seek_descriptor, buffer_size, buffer, p_write_amount ) ;
}
...
fsal_status_t WRAP_POSIXFSAL_open_by_fileid(fsal_handle_t * filehandle,   /* IN */
                                  ...
                                  fsal_attrib_list_t * file_attributes /* [ IN/OUT ] */ )
{
   return POSIXFSAL_open_by_fileid( (posixfsal_handle_t *)filehandle, fileid, (posixfsal_op_context_t *)p_context, 
                                   openflags, (posixfsal_file_t *)file_descriptor, file_attributes ) ;
}
...
{
  return POSIXFSAL_static_fsinfo( (posixfsal_handle_t *)p_filehandle, (posixfsal_op_context_t *)p_context, p_staticinfo ) ;
}
...
{
  return POSIXFSAL_dynamic_fsinfo( (posixfsal_handle_t *)p_filehandle, (posixfsal_op_context_t *)p_context, p_dynamicinfo ) ;
}
...
{
  return POSIXFSAL_test_access( (posixfsal_op_context_t *)p_context, access_type, p_object_attributes ) ;
}
...
{
  return POSIXFSAL_setattr_access( (posixfsal_op_context_t *)p_context, candidate_attributes, object_attributes ) ;
}
...
{
  return POSIXFSAL_rename_access( (posixfsal_op_context_t *)pcontext, pattrsrc, pattrdest ) ;
}
...
fsal_status_t WRAP_POSIXFSAL_lookup(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */)
{
  return POSIXFSAL_lookup( (posixfsal_handle_t *)p_parent_directory_handle, p_filename, (posixfsal_op_context_t *)p_context,
...
fsal_status_t WRAP_POSIXFSAL_lookupPath(fsal_path_t * p_path,     /* IN */
                              ...
                              fsal_attrib_list_t * p_object_attributes  /* [ IN/OUT ] */)
{
  return POSIXFSAL_lookupPath( p_path, (posixfsal_op_context_t *)p_context, (posixfsal_handle_t *)object_handle, p_object_attributes ) ;
}
...
{  
  return POSIXFSAL_lookupJunction( (posixfsal_handle_t *)p_junction_handle, (posixfsal_op_context_t *)p_context, (posixfsal_handle_t *)p_fsoot_handle, p_fsroot_attributes ) ;
}

fsal_status_t WRAP_POSIXFSAL_lock(fsal_file_t * obj_handle,
                        fsal_lockdesc_t * ldesc, fsal_boolean_t blocking)
{
  return POSIXFSAL_lock( (posixfsal_file_t *)obj_handle, (posixfsal_lockdesc_t *)ldesc, blocking ) ;
}
...
{
  return POSIXFSAL_unlock( (posixfsal_file_t *)obj_handle, (posixfsal_lockdesc_t *)ldesc ) ;
}

fsal_status_t WRAP_POSIXFSAL_getlock(fsal_file_t * obj_handle, fsal_lockdesc_t * ldesc)
{
  return POSIXFSAL_getlock( (posixfsal_file_t *)obj_handle, (posixfsal_lockdesc_t *)ldesc ) ;
}
...
{
  return POSIXFSAL_rcp( (posixfsal_handle_t *)filehandle, (posixfsal_op_context_t *)p_context, p_local_path, transfer_opt ) ;
}
...
fsal_status_t WRAP_POSIXFSAL_rcp_by_fileid(fsal_handle_t * filehandle,    /* IN */
                                 ...
                                 fsal_rcpflag_t transfer_opt /* IN */ ) 
{
  return POSIXFSAL_rcp_by_fileid( (posixfsal_handle_t *)filehandle, fileid, (posixfsal_op_context_t *)p_context, p_local_path, transfer_opt ) ;
}
...
{
  return POSIXFSAL_rename( (posixfsal_handle_t *)p_old_parentdir_handle, p_old_name, (posixfsal_handle_t *)p_new_parentdir_handle, p_new_name, 
					 (posixfsal_op_context_t *)p_context, p_src_dir_attributes, p_tgt_dir_attributes ) ;
}
...
{
  return POSIXFSAL_readlink( (posixfsal_handle_t *)p_linkhandle, (posixfsal_op_context_t *)p_context, p_link_content, p_link_attributes ) ;
}
...
fsal_status_t WRAP_POSIXFSAL_symlink(fsal_handle_t * p_parent_directory_handle,   /* IN */
                           ...
                           fsal_attrib_list_t * p_link_attributes       /* [ IN/OUT ] */) 
{
  return POSIXFSAL_symlink( (posixfsal_handle_t *)p_parent_directory_handle, p_linkname, p_linkcontent, 
					  (posixfsal_op_context_t *)p_context, accessmode, (posixfsal_handle_t *)p_link_handle, p_link_attributes ) ;
}

int WRAP_POSIXFSAL_handlecmp(fsal_handle_t * handle1, fsal_handle_t * handle2,
                   fsal_status_t * status) 
{
  return POSIXFSAL_handlecmp( (posixfsal_handle_t *)handle1, (posixfsal_handle_t *)handle2, status ) ;
}
...
{
  return POSIXFSAL_Handle_to_HashIndex( (posixfsal_handle_t *)p_handle, cookie, alphabet_len, index_size ) ;
}

unsigned int WRAP_POSIXFSAL_Handle_to_RBTIndex(fsal_handle_t * p_handle, unsigned int cookie)
{
...
{
  return POSIXFSAL_DigestHandle( (posixfsal_export_context_t *)p_exportcontext, output_type, (posixfsal_handle_t *)p_in_fsal_handle, out_buff ) ;
}
...
{
  return POSIXFSAL_ExpandHandle( (posixfsal_export_context_t *)p_expcontext, in_type, in_buff, (posixfsal_handle_t *)p_out_fsal_handle ) ;
}
...
fsal_status_t WRAP_POSIXFSAL_SetDefault_FS_common_parameter(fsal_parameter_t * out_parameter)
{
  return POSIXFSAL_SetDefault_FS_common_parameter( out_parameter ) ;
}

fsal_status_t WRAP_POSIXFSAL_SetDefault_FS_specific_parameter(fsal_parameter_t * out_parameter)
{
...
{
  return POSIXFSAL_truncate( (posixfsal_handle_t *)p_filehandle, (posixfsal_op_context_t *)p_context, length, 
...
{
  return POSIXFSAL_unlink( (posixfsal_handle_t *)p_parent_directory_handle, p_object_name, (posixfsal_op_context_t *)p_context, p_parent_directory_attributes ) ;
} 
...
{
  return POSIXFSAL_GetXAttrAttrs( (posixfsal_handle_t *)p_objecthandle, (posixfsal_op_context_t *)p_context, xattr_id, p_attrs ) ;
}
...
fsal_status_t WRAP_POSIXFSAL_ListXAttrs(fsal_handle_t * p_objecthandle,   /* IN */
                              ...
                              int *end_of_list  /* OUT */ ) 
{
  return POSIXFSAL_ListXAttrs( (posixfsal_handle_t *)p_objecthandle, cookie, (posixfsal_op_context_t *)p_context,
...
{
  return POSIXFSAL_GetXAttrValueById( (posixfsal_handle_t *)p_objecthandle, xattr_id, (posixfsal_op_context_t *)p_context, 
...
{
  return POSIXFSAL_GetXAttrIdByName( (posixfsal_handle_t *)p_objecthandle, xattr_name, (posixfsal_op_context_t *)p_context, pxattr_id ) ;
}
...
{
  return POSIXFSAL_GetXAttrValueByName( (posixfsal_handle_t *)p_objecthandle, xattr_name, (posixfsal_op_context_t *)p_context,
						      buffer_addr, buffer_size, p_output_size ) ;
}
...
fsal_status_t WRAP_POSIXFSAL_SetXAttrValue(fsal_handle_t * p_objecthandle,        /* IN */
                                 ...
                                 int create     /* IN */) 
{
  return POSIXFSAL_SetXAttrValue( (posixfsal_handle_t *)p_objecthandle, xattr_name, (posixfsal_op_context_t *)p_context,
...
fsal_status_t WRAP_POSIXFSAL_SetXAttrValueById(fsal_handle_t * p_objecthandle,    /* IN */
                                     ...
                                     size_t buffer_size /* IN */ ) 
{
  return POSIXFSAL_SetXAttrValueById( (posixfsal_handle_t *)p_objecthandle, xattr_id, (posixfsal_op_context_t *)p_context,
...
fsal_status_t WRAP_POSIXFSAL_RemoveXAttrById(fsal_handle_t * p_objecthandle,      /* IN */
                                   ...
                                   unsigned int xattr_id)       /* IN */
{
  return POSIXFSAL_RemoveXAttrById( (posixfsal_handle_t *)p_objecthandle, (posixfsal_op_context_t *)p_context, xattr_id ) ;
}
...
{
  return POSIXFSAL_RemoveXAttrByName( (posixfsal_handle_t *)p_objecthandle, (posixfsal_op_context_t *)p_context, xattr_name ) ;
}
...
fsal_functions_t fsal_xfs_functions = {
  ...
  .fsal_setdefault_fs_specific_parameter = WRAP_POSIXFSAL_SetDefault_FS_specific_parameter,
  .fsal_load_fsal_parameter_from_conf = WRAP_POSIXFSAL_load_FSAL_parameter_from_conf,
  .fsal_load_fs_common_parameter_from_conf = WRAP_POSIXFSAL_load_FS_common_parameter_from_conf,
  .fsal_load_fs_specific_parameter_from_conf = WRAP_POSIXFSAL_load_FS_specific_parameter_from_conf,
