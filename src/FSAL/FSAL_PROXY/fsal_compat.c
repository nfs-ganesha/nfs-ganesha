...
fsal_functions_t fsal_proxy_functions = {
  ...
  .fsal_getclientcontext = PROXYFSAL_GetClientContext,
  ...
  .fsal_rename_access = PROXYFSAL_rename_access,
  .fsal_create_access = PROXYFSAL_create_access,
  .fsal_unlink_access = PROXYFSAL_unlink_access,
  .fsal_link_access = PROXYFSAL_link_access,
  .fsal_merge_attrs = PROXYFSAL_merge_attrs,
  .fsal_lookup = PROXYFSAL_lookup,
  .fsal_lookuppath = PROXYFSAL_lookupPath,
  .fsal_lookupjunction = PROXYFSAL_lookupJunction,
  .fsal_lock = PROXYFSAL_lock,
  .fsal_changelock = PROXYFSAL_changelock,
  .fsal_unlock = PROXYFSAL_unlock,
  .fsal_getlock = PROXYFSAL_getlock,
  .fsal_cleanobjectresources = PROXYFSAL_CleanObjectResources,
  .fsal_set_quota = PROXYFSAL_set_quota,
  .fsal_get_quota = PROXYFSAL_get_quota,
