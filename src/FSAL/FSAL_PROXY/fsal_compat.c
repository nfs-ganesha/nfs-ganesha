...
{
  return PROXYFSAL_access( (proxyfsal_handle_t *)object_handle, (proxyfsal_op_context_t *)p_context, access_type, object_attributes ) ;
}
...
{
  return PROXYFSAL_getattrs( (proxyfsal_handle_t *)p_filehandle, (proxyfsal_op_context_t *)p_context, p_object_attributes ) ;
}
...
fsal_status_t WRAP_PROXYFSAL_setattrs(fsal_handle_t * p_filehandle,       /* IN */
                            ...
                            fsal_attrib_list_t * p_object_attributes    /* [ IN/OUT ] */)
{
  return PROXYFSAL_setattrs( (proxyfsal_handle_t *)p_filehandle, (proxyfsal_op_context_t *)p_context, p_attrib_set, p_object_attributes ) ;
}
...
{
  return PROXYFSAL_BuildExportContext( (proxyfsal_export_context_t *)p_export_context, p_export_path, fs_specific_options ) ;
}
...
{
  return PROXYFSAL_GetClientContext( (proxyfsal_op_context_t *)p_thr_context, (proxyfsal_export_context_t *)p_export_context, uid, gid, alt_groups, nb_alt_groups ) ;
}
...
fsal_status_t WRAP_PROXYFSAL_create(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */ ) 
{
  return PROXYFSAL_create( (proxyfsal_handle_t *) p_parent_directory_handle, p_filename, (proxyfsal_op_context_t *)p_context,
			   accessmode, (proxyfsal_handle_t *)p_object_handle, p_object_attributes ) ;
}
...
fsal_status_t WRAP_PROXYFSAL_mkdir(fsal_handle_t * p_parent_directory_handle,     /* IN */
                         ...
                         fsal_attrib_list_t * p_object_attributes       /* [ IN/OUT ] */)
{
  return PROXYFSAL_mkdir( (proxyfsal_handle_t *)p_parent_directory_handle, p_dirname, (proxyfsal_op_context_t *)p_context,
					accessmode, (proxyfsal_handle_t *)p_object_handle, p_object_attributes ) ;
}
...
{
  return PROXYFSAL_link( (proxyfsal_handle_t *)p_target_handle, (proxyfsal_handle_t *)p_dir_handle, p_link_name, (proxyfsal_op_context_t *)p_context, p_attributes ) ;
}
...
{
  return PROXYFSAL_mknode( (proxyfsal_handle_t *)parentdir_handle, p_node_name, (proxyfsal_op_context_t *)p_context, accessmode,
					 nodetype, dev,   (proxyfsal_handle_t *)p_object_handle, node_attributes ) ;
}
...
{
  return PROXYFSAL_opendir( (proxyfsal_handle_t *)p_dir_handle, (proxyfsal_op_context_t *)p_context, 
                           ...
                           fsal_boolean_t * p_end_of_dir        /* OUT */ ) 
{
  ...
  return PROXYFSAL_readdir( (proxyfsal_dir_t *)p_dir_descriptor, proxycookie, get_attr_mask,
	     		  buffersize, p_pdirent, (proxyfsal_cookie_t *)p_end_position, p_nb_entries, p_end_of_dir ) ;
}
                                ...
                                fsal_attrib_list_t * file_attributes /* [ IN/OUT ] */ )
{
  return PROXYFSAL_open_by_name( (proxyfsal_handle_t *)dirhandle, filename, 
			       (proxyfsal_op_context_t *)p_context, openflags, (proxyfsal_file_t *)file_descriptor, file_attributes ) ;
}
...
{
  return PROXYFSAL_open( (proxyfsal_handle_t *)p_filehandle, (proxyfsal_op_context_t *)p_context, 
                       openflags, (proxyfsal_file_t *)p_file_descriptor, p_file_attributes ) ;
}
...
{
  return PROXYFSAL_read( (proxyfsal_file_t *)p_file_descriptor, p_seek_descriptor, buffer_size, buffer, p_read_amount, p_end_of_file ) ;
}
...
{
  return PROXYFSAL_write( (proxyfsal_file_t *)p_file_descriptor, p_seek_descriptor, buffer_size, buffer, p_write_amount ) ;
}
...
fsal_status_t WRAP_PROXYFSAL_open_by_fileid(fsal_handle_t * filehandle,   /* IN */
                                  ...
                                  fsal_attrib_list_t * file_attributes /* [ IN/OUT ] */ )
{
   return PROXYFSAL_open_by_fileid( (proxyfsal_handle_t *)filehandle, fileid, (proxyfsal_op_context_t *)p_context, 
                                   openflags, (proxyfsal_file_t *)file_descriptor, file_attributes ) ;
}
...
{
  return PROXYFSAL_static_fsinfo( (proxyfsal_handle_t *)p_filehandle, (proxyfsal_op_context_t *)p_context, p_staticinfo ) ;
}
...
{
  return PROXYFSAL_dynamic_fsinfo( (proxyfsal_handle_t *)p_filehandle, (proxyfsal_op_context_t *)p_context, p_dynamicinfo ) ;
}
...
{
  return PROXYFSAL_test_access( (proxyfsal_op_context_t *)p_context, access_type, p_object_attributes ) ;
}
...
{
  return PROXYFSAL_setattr_access( (proxyfsal_op_context_t *)p_context, candidate_attributes, object_attributes ) ;
}
...
{
  return PROXYFSAL_rename_access( (proxyfsal_op_context_t *)pcontext, pattrsrc, pattrdest ) ;
}
...
fsal_status_t WRAP_PROXYFSAL_lookup(fsal_handle_t * p_parent_directory_handle,    /* IN */
                          ...
                          fsal_attrib_list_t * p_object_attributes      /* [ IN/OUT ] */)
{
  return PROXYFSAL_lookup( (proxyfsal_handle_t *)p_parent_directory_handle, p_filename, (proxyfsal_op_context_t *)p_context,
...
fsal_status_t WRAP_PROXYFSAL_lookupPath(fsal_path_t * p_path,     /* IN */
                              ...
                              fsal_attrib_list_t * p_object_attributes  /* [ IN/OUT ] */)
{
  return PROXYFSAL_lookupPath( p_path, (proxyfsal_op_context_t *)p_context, (proxyfsal_handle_t *)object_handle, p_object_attributes ) ;
}
...
{  
  return PROXYFSAL_lookupJunction( (proxyfsal_handle_t *)p_junction_handle, (proxyfsal_op_context_t *)p_context, (proxyfsal_handle_t *)p_fsoot_handle, p_fsroot_attributes ) ;
}

fsal_status_t WRAP_PROXYFSAL_lock(fsal_file_t * obj_handle,
                        fsal_lockdesc_t * ldesc, fsal_boolean_t blocking)
{
  return PROXYFSAL_lock( (proxyfsal_file_t *)obj_handle, (proxyfsal_lockdesc_t *)ldesc, blocking ) ;
}
...
{
  return PROXYFSAL_unlock( (proxyfsal_file_t *)obj_handle, (proxyfsal_lockdesc_t *)ldesc ) ;
}

fsal_status_t WRAP_PROXYFSAL_getlock(fsal_file_t * obj_handle, fsal_lockdesc_t * ldesc)
{
  return PROXYFSAL_getlock( (proxyfsal_file_t *)obj_handle, (proxyfsal_lockdesc_t *)ldesc ) ;
}
...
{
  return PROXYFSAL_rcp( (proxyfsal_handle_t *)filehandle, (proxyfsal_op_context_t *)p_context, p_local_path, transfer_opt ) ;
}
...
fsal_status_t WRAP_PROXYFSAL_rcp_by_fileid(fsal_handle_t * filehandle,    /* IN */
                                 ...
                                 fsal_rcpflag_t transfer_opt /* IN */ ) 
{
  return PROXYFSAL_rcp_by_fileid( (proxyfsal_handle_t *)filehandle, fileid, (proxyfsal_op_context_t *)p_context, p_local_path, transfer_opt ) ;
}
...
{
  return PROXYFSAL_rename( (proxyfsal_handle_t *)p_old_parentdir_handle, p_old_name, (proxyfsal_handle_t *)p_new_parentdir_handle, p_new_name, 
					 (proxyfsal_op_context_t *)p_context, p_src_dir_attributes, p_tgt_dir_attributes ) ;
}
...
{
  return PROXYFSAL_readlink( (proxyfsal_handle_t *)p_linkhandle, (proxyfsal_op_context_t *)p_context, p_link_content, p_link_attributes ) ;
}
...
fsal_status_t WRAP_PROXYFSAL_symlink(fsal_handle_t * p_parent_directory_handle,   /* IN */
                           ...
                           fsal_attrib_list_t * p_link_attributes       /* [ IN/OUT ] */) 
{
  return PROXYFSAL_symlink( (proxyfsal_handle_t *)p_parent_directory_handle, p_linkname, p_linkcontent, 
					  (proxyfsal_op_context_t *)p_context, accessmode, (proxyfsal_handle_t *)p_link_handle, p_link_attributes ) ;
}

int WRAP_PROXYFSAL_handlecmp(fsal_handle_t * handle1, fsal_handle_t * handle2,
                   fsal_status_t * status) 
{
  return PROXYFSAL_handlecmp( (proxyfsal_handle_t *)handle1, (proxyfsal_handle_t *)handle2, status ) ;
}
...
{
  return PROXYFSAL_Handle_to_HashIndex( (proxyfsal_handle_t *)p_handle, cookie, alphabet_len, index_size ) ;
}

unsigned int WRAP_PROXYFSAL_Handle_to_RBTIndex(fsal_handle_t * p_handle, unsigned int cookie)
{
...
{
  return PROXYFSAL_DigestHandle( (proxyfsal_export_context_t *)p_exportcontext, output_type, (proxyfsal_handle_t *)p_in_fsal_handle, out_buff ) ;
}
...
{
  return PROXYFSAL_ExpandHandle( (proxyfsal_export_context_t *)p_expcontext, in_type, in_buff, (proxyfsal_handle_t *)p_out_fsal_handle ) ;
}
...
fsal_status_t WRAP_PROXYFSAL_SetDefault_FS_common_parameter(fsal_parameter_t * out_parameter)
{
  return PROXYFSAL_SetDefault_FS_common_parameter( out_parameter ) ;
}

fsal_status_t WRAP_PROXYFSAL_SetDefault_FS_specific_parameter(fsal_parameter_t * out_parameter)
{
...
{
  return PROXYFSAL_truncate( (proxyfsal_handle_t *)p_filehandle, (proxyfsal_op_context_t *)p_context, length, 
...
{
  return PROXYFSAL_unlink( (proxyfsal_handle_t *)p_parent_directory_handle, p_object_name, (proxyfsal_op_context_t *)p_context, p_parent_directory_attributes ) ;
} 
...
{
  return PROXYFSAL_GetXAttrAttrs( (proxyfsal_handle_t *)p_objecthandle, (proxyfsal_op_context_t *)p_context, xattr_id, p_attrs ) ;
}
...
fsal_status_t WRAP_PROXYFSAL_ListXAttrs(fsal_handle_t * p_objecthandle,   /* IN */
                              ...
                              int *end_of_list  /* OUT */ ) 
{
  return PROXYFSAL_ListXAttrs( (proxyfsal_handle_t *)p_objecthandle, cookie, (proxyfsal_op_context_t *)p_context,
...
{
  return PROXYFSAL_GetXAttrValueById( (proxyfsal_handle_t *)p_objecthandle, xattr_id, (proxyfsal_op_context_t *)p_context, 
...
{
  return PROXYFSAL_GetXAttrIdByName( (proxyfsal_handle_t *)p_objecthandle, xattr_name, (proxyfsal_op_context_t *)p_context, pxattr_id ) ;
}
...
{
  return PROXYFSAL_GetXAttrValueByName( (proxyfsal_handle_t *)p_objecthandle, xattr_name, (proxyfsal_op_context_t *)p_context,
						      buffer_addr, buffer_size, p_output_size ) ;
}
...
fsal_status_t WRAP_PROXYFSAL_SetXAttrValue(fsal_handle_t * p_objecthandle,        /* IN */
                                 ...
                                 int create     /* IN */) 
{
  return PROXYFSAL_SetXAttrValue( (proxyfsal_handle_t *)p_objecthandle, xattr_name, (proxyfsal_op_context_t *)p_context,
...
fsal_status_t WRAP_PROXYFSAL_SetXAttrValueById(fsal_handle_t * p_objecthandle,    /* IN */
                                     ...
                                     size_t buffer_size /* IN */ ) 
{
  return PROXYFSAL_SetXAttrValueById( (proxyfsal_handle_t *)p_objecthandle, xattr_id, (proxyfsal_op_context_t *)p_context,
...
fsal_status_t WRAP_PROXYFSAL_RemoveXAttrById(fsal_handle_t * p_objecthandle,      /* IN */
                                   ...
                                   unsigned int xattr_id)       /* IN */
{
  return PROXYFSAL_RemoveXAttrById( (proxyfsal_handle_t *)p_objecthandle, (proxyfsal_op_context_t *)p_context, xattr_id ) ;
}
...
{
  return PROXYFSAL_RemoveXAttrByName( (proxyfsal_handle_t *)p_objecthandle, (proxyfsal_op_context_t *)p_context, xattr_name ) ;
}
...
fsal_functions_t fsal_proxy_functions = {
  ...
  .fsal_setdefault_fs_specific_parameter = WRAP_PROXYFSAL_SetDefault_FS_specific_parameter,
  .fsal_load_fsal_parameter_from_conf = WRAP_PROXYFSAL_load_FSAL_parameter_from_conf,
  .fsal_load_fs_common_parameter_from_conf = WRAP_PROXYFSAL_load_FS_common_parameter_from_conf,
  .fsal_load_fs_specific_parameter_from_conf = WRAP_PROXYFSAL_load_FS_specific_parameter_from_conf,
