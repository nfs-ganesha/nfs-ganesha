...
#define FSAL_OPEN_VAL_BUFFER  1024
  ...
  /* Create the owner */
  snprintf( owner_val, FSAL_PROXY_OWNER_LEN, "GANESHA/PROXY: pid=%u ctx=%p file=%llu", getpid(), p_context, p_context->file_counter );
...
#define FSAL_OPEN_IDX_OP_GETATTR       3 
  ...
  COMPOUNDV4_ARG_ADD_OP_OPEN_NOCREATE( argnfs4, file_descriptor->stateid.seqid, p_context->clientid , share_access, name, owner_val, owner_len ) ; 
  COMPOUNDV4_ARG_ADD_OP_GETFH( argnfs4 ) ; 
  COMPOUNDV4_ARG_ADD_OP_GETATTR( argnfs4, bitmap ) ; 

  resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_OPEN_NOCREATE].nfs_resop4_u.opopen.OPEN4res_u.resok4.attrset.bitmap4_val = bitmap_res ; 
  resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_OPEN_NOCREATE].nfs_resop4_u.opopen.OPEN4res_u.resok4.attrset.bitmap4_len = 2 ; 

  resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes.attrmask.bitmap4_val = bitmap_getattr_res ; 
  resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes.attrmask.bitmap4_len = 2 ;

  resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes.attr_vals.attrlist4_val = (char *)&fattr_internal ; 
  resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes.attr_vals.attrlist4_len = sizeof( fattr_internal ) ; 

  resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_GETFH].nfs_resop4_u.opgetfh.GETFH4res_u.resok4.object.nfs_fh4_val = (char *)padfilehandle ; 
  resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_GETFH].nfs_resop4_u.opgetfh.GETFH4res_u.resok4.object.nfs_fh4_len = FSAL_PROXY_FILEHANDLE_MAX_LEN ;
  ...
  if( nfs4_Fattr_To_FSAL_attr(
              &attributes,
              &resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes ) != 1 )
  {
  ...
  if( fsal_internal_proxy_create_fh(
               &resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_GETFH].nfs_resop4_u.opgetfh.GETFH4res_u.resok4.object,
               FSAL_TYPE_FILE,
               attributes.fileid,
  ...
  file_descriptor->stateid.seqid = resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_OPEN_NOCREATE].nfs_resop4_u.opopen.OPEN4res_u.resok4.stateid.seqid ;
  memcpy( (char *)file_descriptor->stateid.other, 
          resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_OPEN_NOCREATE].nfs_resop4_u.opopen.OPEN4res_u.resok4.stateid.other, 
          12 ) ;
  
  /* See if a OPEN_CONFIRM is required */
  if( resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_OPEN_NOCREATE].nfs_resop4_u.opopen.OPEN4res_u.resok4.rflags & OPEN4_RESULT_CONFIRM )
   {
...
static fsal_status_t FSAL_open_stateless(
...
#define FSAL_OPEN_STATELESS_IDX_OP_GETATTR       1 
  ...
  resnfs4.resarray.resarray_val[FSAL_OPEN_STATELESS_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes.attrmask.bitmap4_val = bitmap_getattr_res ; 
  resnfs4.resarray.resarray_val[FSAL_OPEN_STATELESS_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes.attrmask.bitmap4_len = 2 ;

  resnfs4.resarray.resarray_val[FSAL_OPEN_STATELESS_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes.attr_vals.attrlist4_val = (char *)&fattr_internal ; 
  resnfs4.resarray.resarray_val[FSAL_OPEN_STATELESS_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes.attr_vals.attrlist4_len = sizeof( fattr_internal ) ; 
  ...
  if( file_attributes )
   {
     if( nfs4_Fattr_To_FSAL_attr(
                 &attributes,
                 &resnfs4.resarray.resarray_val[FSAL_OPEN_STATELESS_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes ) != 1 )
      {
        FSAL_CLEAR_MASK( file_attributes->asked_attributes );
        FSAL_SET_MASK( file_attributes->asked_attributes, FSAL_ATTR_RDATTR_ERR );
...
fsal_status_t FSAL_open(
  ...
  fsal_status = FSAL_open_stateless( filehandle, p_context, openflags, file_descriptor, file_attributes ) ;
...
#define FSAL_READ_IDX_OP_READ    1
  ...
  resnfs4.resarray.resarray_val[FSAL_READ_IDX_OP_READ].nfs_resop4_u.opread.READ4res_u.resok4.data.data_val = buffer ;
  ...
  *end_of_file = resnfs4.resarray.resarray_val[FSAL_READ_IDX_OP_READ].nfs_resop4_u.opread.READ4res_u.resok4.eof ;
  *read_amount =  resnfs4.resarray.resarray_val[FSAL_READ_IDX_OP_READ].nfs_resop4_u.opread.READ4res_u.resok4.data.data_len ;

  /* update the offset within the fsal_fd_t */
  file_descriptor->current_offset +=  resnfs4.resarray.resarray_val[FSAL_READ_IDX_OP_READ].nfs_resop4_u.opread.READ4res_u.resok4.data.data_len ;
...
#define FSAL_READ_IDX_OP_WRITE    1
  ...
  COMPOUNDV4_ARG_ADD_OP_PUTFH( argnfs4, nfs4fh ) ;
  COMPOUNDV4_ARG_ADD_OP_WRITE( argnfs4,  &(file_descriptor->stateid), offset, buffer, buffer_size ) ;
 ...
 /* Set write_amount */
 *write_amount = (fsal_size_t)resnfs4.resarray.resarray_val[FSAL_READ_IDX_OP_WRITE].nfs_resop4_u.opwrite.WRITE4res_u.resok4.count ;

  /* update the offset within the fsal_fd_t */
  file_descriptor->current_offset += resnfs4.resarray.resarray_val[FSAL_READ_IDX_OP_WRITE].nfs_resop4_u.opwrite.WRITE4res_u.resok4.count ;
...
#define FSAL_CLOSE_BY_FILEID_NB_OP 4
  ...
  if( fsal_internal_proxy_extract_fh( &nfs4fh_hldir, &(file_descriptor->pcontext->openfh_wd_handle) ) == FALSE )
    Return(ERR_FSAL_FAULT ,0 , INDEX_FSAL_close_by_fileid);
...
#define FSAL_OPEN_VAL_BUFFER  1024
 ...
 if ( filehandle->object_type_reminder != FSAL_TYPE_FILE )
  ...
  if( fsal_internal_proxy_extract_fh( &nfs4fh_hldir, &(p_context->openfh_wd_handle) ) == FALSE )
   {
     Return(ERR_FSAL_FAULT ,0 , INDEX_FSAL_open_by_fileid);
   }
  bitmap.bitmap4_val = bitmap_open ;
...
#define FSAL_OPEN_BYFID_IDX_OP_GETATTR       6 
  ...
  resnfs4.resarray.resarray_val[FSAL_OPEN_BYFID_IDX_OP_OPEN_NOCREATE].nfs_resop4_u.opopen.OPEN4res_u.resok4.attrset.bitmap4_val = bitmap_res ; 
  resnfs4.resarray.resarray_val[FSAL_OPEN_BYFID_IDX_OP_OPEN_NOCREATE].nfs_resop4_u.opopen.OPEN4res_u.resok4.attrset.bitmap4_len = 2 ; 

  resnfs4.resarray.resarray_val[FSAL_OPEN_BYFID_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes.attrmask.bitmap4_val = bitmap_getattr_res ; 
  resnfs4.resarray.resarray_val[FSAL_OPEN_BYFID_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes.attrmask.bitmap4_len = 2 ; 

  resnfs4.resarray.resarray_val[FSAL_OPEN_BYFID_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes.attr_vals.attrlist4_val = (char *)&fattr_internal ; 
  resnfs4.resarray.resarray_val[FSAL_OPEN_BYFID_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes.attr_vals.attrlist4_len = sizeof( fattr_internal ) ; 

  resnfs4.resarray.resarray_val[FSAL_OPEN_BYFID_IDX_OP_GETFH].nfs_resop4_u.opgetfh.GETFH4res_u.resok4.object.nfs_fh4_val = (char *)padfilehandle ; 
  resnfs4.resarray.resarray_val[FSAL_OPEN_BYFID_IDX_OP_GETFH].nfs_resop4_u.opgetfh.GETFH4res_u.resok4.object.nfs_fh4_len = FSAL_PROXY_FILEHANDLE_MAX_LEN ;
  ...
  if( nfs4_Fattr_To_FSAL_attr(
              &attributes,
              &resnfs4.resarray.resarray_val[FSAL_OPEN_BYFID_IDX_OP_GETATTR].nfs_resop4_u.opgetattr.GETATTR4res_u.resok4.obj_attributes ) != 1 )
  {
     FSAL_CLEAR_MASK( file_attributes->asked_attributes );
     FSAL_SET_MASK( file_attributes->asked_attributes, FSAL_ATTR_RDATTR_ERR );
  ...
  /* Keep the returned stateid for later use */
  file_descriptor->stateid.seqid = resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_OPEN_NOCREATE].nfs_resop4_u.opopen.OPEN4res_u.resok4.stateid.seqid ;
  memcpy( (char *)file_descriptor->stateid.other, resnfs4.resarray.resarray_val[FSAL_OPEN_IDX_OP_OPEN_NOCREATE].nfs_resop4_u.opopen.OPEN4res_u.resok4.stateid.other, 12 ) ;

    /* >> fill output struct << */
  /* Build the handle */
  if( fsal_internal_proxy_create_fh(
               &resnfs4.resarray.resarray_val[FSAL_OPEN_BYFID_IDX_OP_GETFH].nfs_resop4_u.opgetfh.GETFH4res_u.resok4.object,
               FSAL_TYPE_FILE,
               attributes.fileid,
               &file_descriptor->fhandle ) == FALSE )
   {
  ...
  /* See if a OPEN_CONFIRM is required */
  if( resnfs4.resarray.resarray_val[FSAL_OPEN_BYFID_IDX_OP_OPEN_NOCREATE].nfs_resop4_u.opopen.OPEN4res_u.resok4.rflags & OPEN4_RESULT_CONFIRM )
   {
     fsal_status = FSAL_proxy_open_confirm( file_descriptor ) ;
     if( FSAL_IS_ERROR( fsal_status ) )   
        Return(fsal_status.major, fsal_status.minor , INDEX_FSAL_open);
