...
int
nfs41_op_layoutget(struct nfs_argop4 *op, compound_data_t * data,
...
/**
 * \brief Frees what was allocared to handle nfs41_op_layoutget.
 *
 ...
 */
void
nfs41_op_layoutget_Free(LAYOUTGET4res * resp)
{
