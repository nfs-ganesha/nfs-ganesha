 ...
 *
 * nfs41_op_test_stateid.c : Routines used for managing the NFS4 COMPOUND functions.
 *
 *
 */
#ifdef HAVE_CONFIG_H
...
/**
 *
 * nfs41_op_test_stateid: The NFS4_OP_TEST_STATEID operation.
 *
...
int nfs41_op_test_stateid(struct nfs_argop4 *op, compound_data_t * data, struct nfs_resop4 *resp)
{
  char __attribute__ ((__unused__)) funcname[] = "nfs41_op_test_stateid";
...
/**
 * nfs41_op_test_stateid_Free: frees what was allocared to handle nfs41_op_test_stateid.
 *
 * Frees what was allocared to handle nfs41_op_test_stateid
 *
