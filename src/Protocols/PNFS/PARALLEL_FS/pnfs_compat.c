...
pnfs_functions_t pnfs_ceph_functions = {
  .getdevicelist  = PARALLEL_FS_pnfs_getdevicelist,
  .getdeviceinfo  = PARALLEL_FS_pnfs_getdeviceinfo,
  .layoutget      = PARALLEL_FS_pnfs_layoutget,
  .layoutcommit   = PARALLEL_FS_pnfs_layoutcommit,
  .layoutreturn   = PARALLEL_FS_pnfs_layoutreturn,
