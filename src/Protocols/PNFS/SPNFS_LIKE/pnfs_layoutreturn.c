...
/**
 *
 * pnfs_spnfs_layoutreturn: manages the OP4_LAYOUTRETURN operation for pNFS/File on top of SPNFS
 *
 * Manages the OP4_LAYOUTRETURNT operation for pNFS/File on top of SPNFS
 *
