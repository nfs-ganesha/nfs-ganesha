...
echo "###############################################"
echo
echo "Maintenant, supprimer le repertoire $DIR_2"
echo "directement dans le filesystem (via scrub)"
echo "(commande 'unlink TEST_STALE.$$_bis recurse top')"
echo
...
echo "On tente de deplacer un fichier dans le repertoire supprime"
