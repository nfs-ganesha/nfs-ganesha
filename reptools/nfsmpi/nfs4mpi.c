...
main( int argc, char * argv[] ) 
{
  ...
  compound4_res.resarray.resarray_val = (struct nfs_resop4 *)malloc( 30 * sizeof( struct nfs_resop4 ) ) ;
  ...
  fprintf( stderr, "Node %d [%s] requete v4\n", node, myname ) ;
  ...
  fprintf( stderr, "Node %d [%s] requete v4 OK\n", node, myname ) ;
