...
cp /opt/GANESHA2/src/rpm/RPMS/x86_64/*.rpm /tmp && make clean && make rpms && cp /opt/GANESHA2/src/rpm/RPMS/x86_64/*.rpm /tmp &&
...
./configure --with-fsal=SNMP  --enable-nlm && make rpms && \
cp /opt/GANESHA2/src/rpm/RPMS/x86_64/*.rpm /tmp && make clean && make rpms && cp /opt/GANESHA2/src/rpm/RPMS/x86_64/*.rpm /tmp &&
